...
, public Components::Gas<Scalar, SimpleCompressibleH2O<Scalar> >
{
...
public:
    ...
    static const Scalar gasEnthalpy(Scalar temperature,
                                    Scalar pressure)
    {
        static const Scalar tRef = getParam<Scalar>("SimpleCompressibleH2O.ReferenceTemperature", 293.15);
    ...
    */
    static Scalar vaporizationEnthalpy()
    {
        ...
        //tRef in °C
        static const Scalar tRef = getParam<Scalar>("SimpleCompressibleH2O.ReferenceTemperature", 293.15) - 273.15;
    ...
    {
        static const Scalar bulkModulus = getParam<Scalar>("Materials.WaterBulkModulus", 2.0e9);
