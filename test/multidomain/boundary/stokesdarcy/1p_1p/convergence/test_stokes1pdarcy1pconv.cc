...
int main(int argc, char** argv) try
{
    ...
    stokesVtkWriter.addField(stokesProblem->getAnalyticalPressureSolution(), "pressureExact");
    stokesVtkWriter.addField(stokesProblem->getAnalyticalVelocitySolution(), "velocityExact");
    stokesVtkWriter.addFaceField(stokesProblem->getAnalyticalVelocitySolutionOnFace(), "faceVelocityExact");
    ...
    darcyVtkWriter.addField(darcyProblem->getAnalyticalPressureSolution(), "pressureExact");
    darcyVtkWriter.addField(darcyProblem->getAnalyticalVelocitySolution(), "velocityExact");
