...
#ifndef DUMUX_STOKESDARCY_PROPERTIES_A02_HH
#define DUMUX_STOKESDARCY_PROPERTIES_A02_HH
...
// Set the grid type
// template<class TypeTag>
// struct Grid<TypeTag, TTag::StokesOnePTwoC> { using type = Dune::YaspGrid<3, Dune::TensorProductCoordinates<GetPropType<TypeTag, Properties::Scalar>, 3> >; };
