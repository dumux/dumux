...
#ifndef DUMUX_CONSERVATION_SPATIAL_PARAMS_A02_HH
#define DUMUX_CONSERVATION_SPATIAL_PARAMS_A02_HH
...
: public FVPorousMediumFlowSpatialParamsMP<GridGeometry, Scalar, TwoPTwoCSpatialParams<GridGeometry, Scalar>>
{
    using GridView = typename GridGeometry::GridView;
    using Element = typename GridView::template Codim<0>::Entity;
    using FVElementGeometry = typename GridGeometry::LocalView;
    using SubControlVolume = typename FVElementGeometry::SubControlVolume;
    using ParentType = FVPorousMediumFlowSpatialParamsMP<GridGeometry, Scalar, TwoPTwoCSpatialParams<GridGeometry, Scalar>>;
