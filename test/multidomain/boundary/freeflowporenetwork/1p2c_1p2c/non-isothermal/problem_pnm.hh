...
class PNMOnePNCNIProblem : public PorousMediumFlowProblem<TypeTag>
{
...
public:
    ...
    PNMOnePNCNIProblem(std::shared_ptr<const GridGeometry> gridGeometry,
...
private:
    ...
    { return this->gridGeometry().poreLabel(scv.dofIndex()) == 2; } //TODO: use the right poreLabel
