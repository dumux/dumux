...
int main(int argc, char** argv)
{
    ...
    using FreeFlowMomentumTypeTag = Properties::TTag::FreeFlowOnePNCNIMomentum;
    using FreeFlowMassTypeTag = Properties::TTag::FreeFlowOnePNCNIMass;
    using PoreNetworkTypeTag = Properties::TTag::PNMOnePNCNIModel;
