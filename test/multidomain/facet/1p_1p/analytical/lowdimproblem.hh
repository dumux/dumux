...
SET_BOOL_PROP(OnePLowDim, EnableGridFluxVariablesCache, false);
SET_BOOL_PROP(OnePLowDim, EnableFVGridGeometryCache, false);
...
public:
    ...
    BoundaryTypes boundaryTypesAtPos(const GlobalPosition &globalPos) const
    {
        ...
        if (useDirichletBCs_) values.setAllDirichlet();
