 ...
 */
#ifndef DUMUX_MYCVFE_LOCAL_RESIDUAL_HH
#define DUMUX_MYCVFE_LOCAL_RESIDUAL_HH
...
class MYCVFELocalResidual : public FVLocalResidual<TypeTag>
{
...
public:
                  ...
                  const SubControlVolumeFace& scvf) const
    {
        ...
        if (bc == "OutflowQwFixSn")
        {
            ...
            if ( problem.gridGeometry().poreLabel(outsideScv.dofIndex()) != 3 && problem.gridGeometry().poreLabel(insideScv.dofIndex()) != 3)
            {
            ...
            else if (problem.gridGeometry().poreLabel(outsideScv.dofIndex()) == 3 )
            {
                residual[insideScv.localDofIndex()] += flux;
                flux[0] = 0;
                residual[outsideScv.localDofIndex()] -= flux;
            }
            else if (problem.gridGeometry().poreLabel(insideScv.dofIndex()) == 3)
            {
                residual[outsideScv.localDofIndex()] -= flux;
                flux[0] = 0;
                residual[insideScv.localDofIndex()] += flux;
