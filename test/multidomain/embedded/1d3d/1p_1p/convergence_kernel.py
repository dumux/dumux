...
"""
# The script prints a table with errors and
# convergence rates for the kernel coupling method
...
executables = ["test_md_embedded_1d3d_1p1p_tpfabox_kernel", "test_md_embedded_1d3d_1p1p_tpfatpfa_kernel"]
method = {"test_md_embedded_1d3d_1p1p_tpfabox_kernel":1, "test_md_embedded_1d3d_1p1p_tpfatpfa_kernel":3}
label = {"test_md_embedded_1d3d_1p1p_tpfabox_kernel":"Box", "test_md_embedded_1d3d_1p1p_tpfatpfa_kernel":"TPFA"}
marker = {"test_md_embedded_1d3d_1p1p_tpfabox_kernel":"o", "test_md_embedded_1d3d_1p1p_tpfatpfa_kernel":"d"}
cells = [10, 20, 40, 80]
radius = 0.1
