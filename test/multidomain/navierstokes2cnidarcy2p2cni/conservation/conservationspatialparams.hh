...
public:
    ...
    : ParentType(problem, gridView)
    {
        ...
        densitySolid_ = GET_RUNTIME_PARAM_FROM_GROUP(TypeTag, Scalar, SpatialParams, DensitySolid);
        heatCapacitySolid_ = GET_RUNTIME_PARAM_FROM_GROUP(TypeTag, Scalar, SpatialParams, HeatCapacitySolid);
