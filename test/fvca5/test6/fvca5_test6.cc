...
int main(int argc, char** argv)
{
    try{
        ...
        if (argc != 2 && argc != 3) {
            std::cout << "Usage: fvca5_test6 dgffilename [refinementsteps]" << std::endl;
            return (1);
        }
        ...
        Dune::FVCA5Test6Problem<GridType, NumberType, VC> problem(variables, delta);
        ...
        diffusion.vtkout("fvca5_test6", 0);
