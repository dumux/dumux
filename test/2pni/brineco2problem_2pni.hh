//$Id$
#ifndef DUNE_BRINECO2PROBLEM2PNI_HH
#define DUNE_BRINECO2PROBLEM2PNI_HH
...
{
    typedef Dune::BrineCO2Problem2pni<TTAG(BrineCO2Problem2PNI)> type;
};
}
...
class BrineCO2Problem2pni : public BasicDomain<typename GET_PROP_TYPE(TypeTag, PTAG(Grid)),
                                                  typename GET_PROP_TYPE(TypeTag, PTAG(Scalar)) >
{
    ...
    typedef BrineCO2Problem2pni<TypeTag>      ThisType;
