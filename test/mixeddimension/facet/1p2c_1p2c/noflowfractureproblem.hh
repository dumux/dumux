 ...
 */
#ifndef DUMUX_1P2CNI_FRACTURE_PROBLEM_HH
#define DUMUX_1P2CNI_FRACTURE_PROBLEM_HH
...
{
NEW_TYPE_TAG(NoFlowDomainFractureProblem, INHERITS_FROM(CCTpfaModel, OnePTwoCNI));
...
SET_TYPE_PROP(NoFlowDomainFractureProblem, SpatialParams, OnePTwoCFractureSpatialParams<TypeTag>);
...
SET_BOOL_PROP(NoFlowDomainFractureProblem, EnableGlobalFVGeometryCache, true);
}
