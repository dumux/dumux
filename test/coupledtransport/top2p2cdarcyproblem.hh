#ifndef DUNE_TOPTWOPTWOCDARCYPROBLEM_HH
#define DUNE_TOPTWOPTWOCDARCYPROBLEM_HH
...
class TopTwoPTwoCDarcyProblem : public TwoPTwoCProblem<Grid, Scalar>
{
...
public:
    ...
    TopTwoPTwoCDarcyProblem(Liquid_GL& liq, Gas_GL& gas, Matrix2p<Grid, Scalar>& soil, Scalar depthBOR,
...
template<class Grid, class Scalar>
class TopTwoPTwoCDarcySoil: public Matrix2p<Grid,Scalar>
{
...
public:
    ...
    TopTwoPTwoCDarcySoil():Matrix2p<Grid,Scalar>()
    {
        permeability_ = 0.;
        for(int i = 0; i < dim; i++)
            permeability_[i][i] = 1e-1;
    }

    ~TopTwoPTwoCDarcySoil()
    {}
