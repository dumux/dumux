...
//			values[pWIdx] = -1e+3; //- densityW_*gravity_[2]*(height_-x[2]); //-1.0e+6 - densityW_*gravity_[2]*(height_-x[2]);
//			break;
		case 6:
			values[pWIdx] = -1e+4;
			break;
...
//		values[pWIdx] = 1.0e+5 - densityW_*gravity_[2]*(height_-x[2]);
		values[pWIdx] = -1e+4;// - densityW_*gravity_[2]*(height_-x[2]);
