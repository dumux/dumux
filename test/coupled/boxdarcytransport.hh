...
#include "boxdarcytransportjacobian.hh"
...
public:
    ...
    BoxDarcyTransport(const Grid& grid, ProblemType& prob, int level)
...
class LeafP1BoxDarcyTransport : public BoxDarcyTransport<Grid, Scalar, TwoPTwoCProblem<Grid, Scalar>, BoxDarcyTransportJacobian<Grid, Scalar>,
...
public:
    ...
    typedef Dune::BoxDarcyTransport<Grid, Scalar, ProblemType, BoxDarcyTransportJacobian<Grid, Scalar>,
                           FunctionType, OperatorAssembler> BoxDarcyTransport;

    typedef LeafP1BoxDarcyTransport<Grid, Scalar, numEq> ThisType;
    ...
    LeafP1BoxDarcyTransport (const Grid& grid, TwoPTwoCProblem<Grid, Scalar>& prob)
      : BoxDarcyTransport(grid, prob), grid_(grid), vertexmapper(grid.leafView()),
