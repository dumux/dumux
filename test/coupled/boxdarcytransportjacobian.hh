...
class BoxDarcyTransportJacobian
    : public BoxJacobian<BoxDarcyTransportJacobian<Grid,Scalar,BoxFunction>,Grid,Scalar,1,BoxFunction>
{
    enum {numEq=2};
...
public:
    ...
    //! Constructor
    BoxDarcyTransportJacobian (TwoPTwoCProblem<Grid,Scalar>& params,
