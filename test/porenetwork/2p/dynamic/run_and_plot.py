...
intervals   = np.linspace(0.00001, 0.1, 20)
...
for mu in kinematicViscosity:
    ...
    np.savetxt("output_"+str(mu)+".txt", (intervals, totalNewtonIterations, l2Error))


    plt.tight_layout(rect=[0.03, 0.07, 1, 0.93], pad=0.4, w_pad=2.0, h_pad=1.0)
    plt.savefig("Test2_Regularization_"+str(mu)+".pdf", dpi = 300)
