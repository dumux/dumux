...
# plot_excutable_name = "plot_constitutive_relations"
# pc_Sw_logfile = "Pc_Sw.log"
# k_logfile = "K-Sw.log"
...
# print("First, we collect data for drainage process\n")
# print("Collecting Pc-Sw Data for drainage process...\n")
# subprocess.run(["./" + plot_excutable_name] + ["-SpatialParams.RegularizeHighSw", "false"])
# subprocess.run(["mv", pc_Sw_logfile, "Pc_Sw_Dra.log"])
# subprocess.run(["rm", k_logfile])

# print("Collecting K-Pc data for drainage process...")
# subprocess.run(["./" + plot_excutable_name] + ["-SpatialParams.RegularizeHighSw", "false"] + ["-PlotInterval.SwMin", "0.1"])
# print(kwinv)
# subprocess.run(["rm",pc_Sw_logfile])
# subprocess.run(["mv", k_logfile, "K-Sw_Dra.log"])



# print("Then, we collect data for imbibition process\n")
# print("Collecting Pc-Sw Data for imbibition process...\n")


# subprocess.run(["./" + plot_excutable_name] + ["-SpatialParams.RegularizationHighSw", "0.8"])
# subprocess.run(["mv", pc_Sw_logfile, "Pc_Sw_Imb.log"])
# subprocess.run(["rm", k_logfile])

# print("Collecting K-Pc data for imbibition process...")
# subprocess.run(["./" + plot_excutable_name] + ["-SpatialParams.RegularizationHighSw", "0.8"] + ["-PlotInterval.SwMin", "0.1"])

# subprocess.run(["rm",pc_Sw_logfile])
# subprocess.run(["mv", k_logfile, "K-Sw_Imb.log"])
