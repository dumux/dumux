 ...
 */
#ifndef DUMUX_PNM_TWOP_GASWET_IO_FIELDS_HH
#define DUMUX_PNM_TWOP_GASWET_IO_FIELDS_HH
...
public:
    ...
    static void initOutputModule(OutputModule& out)
    {
        ...
        out.addFluxVariable([](const auto& fluxVars, const auto& fluxVarsCache)
                              { return fluxVarsCache.transmissibility(FS::phase1Idx); }, "transmissibilityW");

        out.addFluxVariable([](const auto& fluxVars, const auto& fluxVarsCache)
                              { return fluxVarsCache.transmissibility(FS::phase0Idx); }, "transmissibilityN");
