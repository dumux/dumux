...
#if ISOTHERMAL
template<class TypeTag>
struct IOFields<TypeTag, TTag::ImbibitionProblem> { using type = PoreNetwork::TwoPIOFieldsGasWet; };
#else
//! Set the vtk output fields specific to the non-isothermal two-phase model
template<class TypeTag>
struct IOFields<TypeTag, TTag::ImbibitionProblem> { using type = EnergyIOFields<PoreNetwork::TwoPIOFieldsGasWet>; };
#endif
