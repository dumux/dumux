...
#define TYPETAG_MOMENTUM DFGChannelTestMomentumPQ1Bubble
#endif

#ifndef TYPETAG_MASS
#define TYPETAG_MASS DFGChannelTestMassBox
#endif
...
#include <dumux/freeflow/navierstokes/movingmesh/model.hh>
...
struct DFGChannelTestMomentumPQ1Bubble { using InheritsFrom = std::tuple<DFGChannelTest, NavierStokesMomentumMovingMeshCVFE, PQ1BubbleModel>; };
struct DFGChannelTestMassBox { using InheritsFrom = std::tuple<DFGChannelTest, NavierStokesMassMovingMeshCVFE, BoxModel>; };
} // end namespace TTag
