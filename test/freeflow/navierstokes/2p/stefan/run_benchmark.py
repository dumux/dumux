#!/usr/bin/env python3
"""Run the Stefan evaporation benchmark and plot the first QoI."""
...
def main():
    ...
    csv_path = args.build_dir / "test_ff_stokes_2p_stefan_qoi.csv"
    plot_path = args.build_dir / "test_ff_stokes_2p_stefan_xi.svg"
    ...
    print(
        ...
        f"xi={float(first['xi']):.8g}, "
        f"xi_stefan={float(first['xi_stefan']):.8g}, "
        f"err={float(first['xi_error']):.3g}"
    )
