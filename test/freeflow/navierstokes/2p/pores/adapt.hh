...
// system with vapor transport (NavierStokesMassTwoPVapor mass model).
//
// Primary variables on the mass side: [p, φ, μ, c_v]
...
//   - c_v (vaporIdx)            : transported mass concentration; mass-conservative
//                                 reprojection is needed to preserve ∫ c_v dV under AMR.
//   - p (pressureIdx)           : not extensive; receives plain interpolation.
//
#ifndef DUMUX_TEST_FREEFLOW_2P_PORES_ADAPT_HH
#define DUMUX_TEST_FREEFLOW_2P_PORES_ADAPT_HH
