...
int main(int argc, char** argv)
{
    ...
    using TypeTag = Properties::TTag::SincosTestMomentum;
    ...
    writer.write("sincos_momentum" + discSuffix + "_0");
    ...
    faceVtk.write("sincos_momentum_face" + discSuffix + rankSuffix + "_0", Dune::VTK::ascii);
    ...
    writer.write("sincos_momentum" + discSuffix + "_1");
    faceVtk.write("sincos_momentum_face" + discSuffix + rankSuffix + "_1", Dune::VTK::ascii);
