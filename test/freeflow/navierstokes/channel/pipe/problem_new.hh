                        ...
                        const SubControlVolumeFace& scvf) const
    {
        ...
        if constexpr (ParentType::isMomentumProblem())
        {
            ...
            if (onUpperBoundary_(globalPos))
                values = NavierStokesBoundaryFluxHelper<ModelTraits>::fixedPressureMomentumFlux(*this, element, fvGeometry, scvf, elemVolVars, elemFluxVarsCache, analyticalPressure(globalPos), true /*zeroNormalVelocityGradient*/);
        }
        else
        {
