...
int main(int argc, char** argv)
{
    ...
    using TypeTag = Properties::TTag::KovasznayTestMomentum;
    ...
    writer.write("kovasznay_momentum" + discSuffix + "_0");
    ...
    faceVtk.write("kovasznay_momentum_face" + discSuffix + rankSuffix + "_0", Dune::VTK::ascii);
    ...
    writer.write("kovasznay_momentum" + discSuffix + "_1");
    faceVtk.write("kovasznay_momentum_face" + discSuffix + rankSuffix + "_1", Dune::VTK::ascii);
