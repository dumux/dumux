...
class ArtificialCompressibilityLocalResidual : public NavierStokesMassOnePLocalResidual<TypeTag>
{
...
public:
                               ...
                               const VolumeVariables& volVars) const
    {
        ...
        static const Scalar artificialCompressibility = getParam<Scalar>("Problem.ArtificialCompressibility");
        storage[ModelTraits::Indices::conti0EqIdx] = volVars.density() * volVars.pressure() * artificialCompressibility;
        return storage;
    }
};
...
template<class TypeTag>
struct LocalResidual<TypeTag, TTag::ThreeDChannelTestMass>
{ using type = ArtificialCompressibilityLocalResidual<TypeTag>; };
