...
// manager - no dedicated turbulence coupling manager is needed, since k and
// epsilon-tilde are solved as extra equations on the mass sub-model rather than on a
// separate sub-domain.
template<class TypeTag>
