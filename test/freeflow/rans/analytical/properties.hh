 ...
 */
#ifndef DUMUX_VERIFICATION_KOMEGA_PROPERTIES_HH
#define DUMUX_VERIFICATION_KOMEGA_PROPERTIES_HH
...
{ using type = Dumux::AnalyticalProblem<TypeTag>; };

template<class TypeTag>
struct UpwindSchemeOrder<TypeTag, TTag::RANSModel> { static constexpr int value = 2; };
