 ...
 * \brief A test for the shallow water model in a rough channel with limited Nikuradse friction.
 */
#include <config.h>
...
int main(int argc, char** argv)
{
    ...
    ////////////////////////////////////////////////////////////
    // run unsteady non-linear problem on this grid
    ////////////////////////////////////////////////////////////
    ...
    vtkWriter.write(0.0);
     ...
     // get some time loop parameters and instantiate the time loop
