...
int main(int argc, char** argv)
{
    ...
    PNMVtkOutputModule<GridVariables, GetPropType<TypeTag, Properties::FluxVariables>, SolutionVector> vtkWriter(*gridVariables, x, problem->name());
    ...
    timeLoop->start(); do
    {
        ...
        // problem->postTimeStep(*gridVariables, x);
