...
public:
    ...
    std::vector<IntersectionIterator> lineVectorOnLine;
    std::vector<unsigned> indexVertexVectorOutLine;
    std::vector<IntersectionIterator> lineVectorOutLine;
    ...
    VertexOnLine(VertexPointer node0)
        : nodePoint(node0)
    {
    }
...
int main(int argc, char** argv)
{
    try{
        ...
        Dune::GridPtr<GridType> gridPtr( "grids/rectangle_inner_manual_2d.dgf" );
