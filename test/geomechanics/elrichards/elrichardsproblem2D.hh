...
#include "elrichardsspatialparams2D.hh"
...
NEW_TYPE_TAG(ElRichards_TestProblem, INHERITS_FROM(BoxModel, BoxElasticTwoP, ElRichardsSpatialParams));
...
// Set the grid type
// SET_TYPE_PROP(ElRichards_TestProblem, Grid, Dune::YaspGrid<3>);
