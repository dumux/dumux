...
#include "elrichardsspatialparamsSimple.hh"
...
//             pInit_[vIdxGlobal] = -(1.013e5 + (depthBOR_ - globalPos[dimWorld-1]) * waterDensity_ * 9.81);
            ...
            pInit_[vIdxGlobal] = -pnRef_+waterDensity_*9.81*depth; //pnRef_;//equal to the water pressure and not the pressure in the system which is airpressure.therefore it should be defined from the initial capillary pressure and not the other way round.
        }
    }
...
//     {
//         return 0.0-onLowerBoundary_(globalPos);
//     }
