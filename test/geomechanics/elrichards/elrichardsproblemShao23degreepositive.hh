 ...
 */
#ifndef DUMUX_ELRICHARDS_TE0STPROBLEM_HH
...
//          depthBOR(globalPos) = yMax(globalPos)-globalPos[1];
    ...
    {
//       if (globalPos[0]<15.0+eps_ )
//           return 25.0;
// //       else if (globalPos[0]>30-eps_)
// //           return 19.0;
//       else
        return ((-6.0/45.0)*(globalPos[0]));
// return 25.0;
...
//     }
    ...
    {
        return (globalPos[0] < 0. + eps_ && globalPos[2] > 16. - eps_);
    }
    ...
    {
        return (globalPos[0] >45. - eps_ && globalPos[2] > 16. - eps_);
    }
    ...
    {
        return (globalPos[1] > 20. - eps_ && globalPos[2] > 16. - eps_);
    }
    ...
    {
        return (globalPos[1] < 0. + eps_ && globalPos[2] > 16. - eps_);
    }
