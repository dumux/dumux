...
//         ksUnder_ = GET_RUNTIME_PARAM(TypeTag, Scalar, HydraulicParameters.ksUnder);
        ks_ = GET_RUNTIME_PARAM(TypeTag, Scalar, HydraulicParameters.ks);
...
//           Scalar swrOver_ = GET_RUNTIME_PARAM(TypeTag, Scalar, HydraulicParameters.residualWaterContentOver);
          Scalar swr_ = GET_RUNTIME_PARAM(TypeTag, Scalar, HydraulicParameters.residualWaterContent);
//           Scalar vgnOver_ = GET_RUNTIME_PARAM(TypeTag, Scalar, HydraulicParameters.nOver);
           Scalar vgn_ = GET_RUNTIME_PARAM(TypeTag, Scalar, HydraulicParameters.n);
//           Scalar vgAlphaOver_ = GET_RUNTIME_PARAM(TypeTag, Scalar, HydraulicParameters.alphaOver);
           Scalar vgAlpha_ = GET_RUNTIME_PARAM(TypeTag, Scalar, HydraulicParameters.alpha);
//           Scalar vglOver_= GET_RUNTIME_PARAM(TypeTag, Scalar, HydraulicParameters.lOver);
           Scalar vgl_= GET_RUNTIME_PARAM(TypeTag, Scalar, HydraulicParameters.l);
...
//             return phiUnder_;
        return phi_;
          ...
          Scalar theta_ = GET_RUNTIME_PARAM(TypeTag, Scalar, FailureParameters.FrictionAngle)*M_PI / 180;
          Scalar s0_ = GET_RUNTIME_PARAM(TypeTag, Scalar, FailureParameters.Cohesion);
