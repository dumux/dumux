 ...
 * \file
 *
 * \brief Test for the elrichards cell centered model
 */
#include <config.h>
...
#if HAVE_DUNE_PDELAB
// #include "elrichardsproblemShao2.hh"
// #include "elrichardsproblemShao2DLu.hh"
#include "elrichardsproblemFinal.hh"
#endif
...
{
#if HAVE_DUNE_PDELAB
    typedef TTAG(ElRichards_TestProblem) TypeTag;
