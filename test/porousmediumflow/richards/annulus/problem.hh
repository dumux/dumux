...
public:
    ...
    : ParentType(gridGeometry)
    {
        ...
        if (getParam<bool>("Problem.EnableAnalyticalSourceTerm", true))
        ...
        useStationaryAnalyticInitialSolution_ = getParam<bool>("Problem.UseStationaryAnalyticInitialSolution", true);
    }
...
private:
    ...
    bool useStationaryAnalyticInitialSolution_;
