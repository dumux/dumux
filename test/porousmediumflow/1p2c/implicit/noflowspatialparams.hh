 ...
 */
#ifndef DUMUX_1P2C_NOFLOW_SPATIALPARAMS_HH
#define DUMUX_1P2C_NOFLOW_SPATIALPARAMS_HH
...
class OnePTwoCNoflowSpatialParams;
 ...
 */
template<class TypeTag>
class OnePTwoCNoflowSpatialParams : public ImplicitSpatialParamsOneP<TypeTag>
{
...
public:
    ...
    OnePTwoCNoflowSpatialParams(const Problem& problem, const GridView& gridView)
