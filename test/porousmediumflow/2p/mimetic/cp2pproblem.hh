...
//            7000000,7000000,6000000,7000000,6000000,6000000,7000000,4000000,3000000,4000000});
        ...
        stepIndex_ = 0;
        times_ = std::vector<Scalar>
            ({10000,25000,46250,76355,119000,179419,265010,386264,537832,739923,1009377,1189013,
            1443497,1761603,2106217,2565703,3178351,3944160,4901422,6177772,7560484,9288873,11305328,
            13138469,15429895,18294177,21397149,24500122,27861675,31503358,35145041,37946336,40280748,
            42615160,45338641,48062122,50000000,52700000,55700000,59100000,62900000,67190000,72300000,
            75900000,80100000,85100000,90800000,96600000,100000000,105700000,112000000,119000000,126000000,
            133000000,140000000,147000000,150000000,157000000,165000000,173000000,183000000,190000000,200000000,
            209000000,216000000,223000000,233000000,239000000,247000000,250000000,258000000,267000000,274000000,
            281000000,288000000,294000000,300000000,305000000,312000000,318000000,323000000,329000000,333000000,
            336000000,339000000,343000000,347000000,350000000,354000000,358000000,363000000,369000000,376000000,
            382000000,388000000,396000000,400000000,407000000,415000000,422000000,430000000,437000000,442000000,
            447000000,450000000,455000000,460000000,466000000,473000000,478000000,485000000,492000000,500000000,
            507000000,514000000,518000000,525000000,530000000,536000000,543000000,550000000,557000000,563000000,
            570000000,576000000,582000000,589000000,593000000,596000000,600000000});
    }
...
//            values.setAllNeumann();
    ...
    Scalar nextTimeStepSize(const Scalar dt)
    {
        if(useFixedTimeSteps_)
        {
            ...
            Scalar dtEpisodeEnd = episodeLength_ - fmod(time, episodeLength_);
            if(time > times_[stepIndex_] - 1.0)
                stepIndex_++;

            Scalar dtSuggested = times_[stepIndex_] - time;
