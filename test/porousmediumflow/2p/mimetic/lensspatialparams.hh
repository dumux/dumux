 ...
 */
#ifndef DUMUX_MIMETIC_LENS_SPATIAL_PARAMS_HH
#define DUMUX_MIMETIC_LENS_SPATIAL_PARAMS_HH
...
//        outerMaterialParams_.setVgAlpha(0.00037);
//        outerMaterialParams_.setVgn(4.7);

        lensMaterialParams_.setPe(1.0e3);
        outerMaterialParams_.setPe(1.0e3);
