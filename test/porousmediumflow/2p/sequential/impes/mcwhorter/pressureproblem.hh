 ...
 */
#ifndef DUMUX_MCWHORTER_PRESSURE_TEST_PROBLEM_HH
#define DUMUX_MCWHORTER_PRESSURE_TEST_PROBLEM_HH
...
public:
    ...
    PrimaryVariables dirichletAtPos(const GlobalPosition &globalPos) const
    {
        ...
        const Scalar pc = MaterialLaw::pc(this->spatialParams().materialLawParamsAtPos(globalPos), 0.8);
...
//             values[pressureEqIdx] = 3e-4/NonwettingPhase::density(temperature(), 1.0e5);
         return values;
     }
    /*!
