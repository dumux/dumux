...
public:
    ...
    : ParentType(gridView)
    {
        upperBorder_  = GET_RUNTIME_PARAM(TypeTag, Scalar, SpatialParams.UpperBorder);
        lowerBorder_  = GET_RUNTIME_PARAM(TypeTag, Scalar, SpatialParams.LowerBorder);
...
private:
    ...
    {
            if (globalPos[1] < upperBorder_ && globalPos[1] > lowerBorder_)
                return true;
            else
                return false;
    }
