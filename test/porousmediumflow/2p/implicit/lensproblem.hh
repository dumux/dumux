...
class LensProblem : public GET_PROP_TYPE(TypeTag, BaseProblem)
{
    ...
    typedef typename VertIdxToElemNeighborMapper::NeighborElementScvIterator NeighborElementScvIterator;
...
public:
    ...
    vertexElementScvMapper_(gridView)
    {
        eps_ = 3e-6;
        ...
        name_ = GET_RUNTIME_PARAM_FROM_GROUP(TypeTag,
                                             ...
                                             Problem,
                                             Name);
        vertexElementScvMapper_.update();
    }
    ...
    // \{
        ...
        /*!
     * \brief Returns the vertextoelemscvmapper
     *
     * This is used as a prefix for files generated by the simulation.
     */
    const VertIdxToElemNeighborMapper &vertexElementScvMapper() const
    {
...
private:
    ...
    Scalar eps_;
    std::string name_;
    VertIdxToElemNeighborMapper vertexElementScvMapper_;
};
} //end namespace
