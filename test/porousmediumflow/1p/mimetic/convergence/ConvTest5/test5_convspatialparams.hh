 ...
 *        1p box model
 */
#ifndef DUMUX_TEST5_CONV_SPATIALPARAMS_HH
#define DUMUX_TEST5_CONV_SPATIALPARAMS_HH
...
class Test5ConvSpatialParams : public ImplicitSpatialParamsOneP<TypeTag>
{
...
public:
    ...
    Test5ConvSpatialParams(const Problem& problem, const GridView& gridView)
...
//            //get the Gaussian quadrature rule for intervals
        ...
        for(; qp != qend; ++qp)
        {
            ...
            perm[2][2] += (z*z + alpha_)*qp->weight()*integrationElement;
        }
