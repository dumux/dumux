 ...
 */
#ifndef DUMUX_1PMIMETICTEST_PROBLEM_HH
#define DUMUX_1PMIMETICTEST_PROBLEM_HH
...
{
NEW_TYPE_TAG(OnePTestProblem, INHERITS_FROM(OnePMimetic, OnePTestSpatialParams));
//NEW_TYPE_TAG(OnePTestMimeticProblem, INHERITS_FROM(OnePMimetic, OnePTestProblem));
...
SET_BOOL_PROP(OnePTestProblem, EnableGlobalFluxVariablesCache, true);
SET_BOOL_PROP(OnePTestProblem, EnableGlobalVolumeVariablesCache, true);
}
...
public:
    ...
    PrimaryVariables dirichletAtPos(const GlobalPosition &globalPos) const
    {
        ...
        values[facePressureIdx] = 1.0e+5*(2.0 - globalPos[dimWorld-1]);
        return values;
    }
