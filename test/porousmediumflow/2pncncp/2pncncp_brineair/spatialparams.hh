 ...
 * \brief The spatial parameters for the TwoPNCSaltProblem.
 */

#ifndef DUMUX_2PNC_NCP__SPATIAL_PARAMS_HH
#define DUMUX_2PNC_NCP_SPATIAL_PARAMS_HH
...
/**
 * \ingroup TwoPNCNCPTests
 * \brief Definition of the spatial params properties for the TwoPNCSalt problem.
 *
 */
template<class GridGeometry, class Scalar>
class TwoPNCSaltSpatialParams
: public FVSpatialParams<GridGeometry, Scalar,
                         TwoPNCSaltSpatialParams<GridGeometry, Scalar>>
{
...
public:
    ...
    TwoPNCSaltSpatialParams(std::shared_ptr<const GridGeometry> gridGeometry)
