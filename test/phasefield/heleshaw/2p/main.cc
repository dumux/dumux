...
#include <dumux/phasefield/heleshaw/2p/model.hh>
#include <dumux/phasefield/heleshaw/2p/adapt.hh>
#include "problem.hh"
...
int main(int argc, char** argv)
{
    ...
    auto newton = std::make_shared<NewtonSolver>(assembler, linearSolver);
