...
//				HostVertexPointer vertexPoint1 = element.template entity<dim>(locaIdPoint1onElement);
				...
				{	
					if(NodeParameter[0]!=0)
					{
						...
						{
							VertexOnLine<G> vertex(element.template entity<dim>(locaIdPoint0onElement), param0);
							...
							mapVertexToIndexOnLine[element.template entity<dim>(locaIdPoint0onElement)] = (indexMapVerticesOnLine++);
