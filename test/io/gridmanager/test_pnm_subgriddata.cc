...
int main(int argc, char** argv)
{
    ...
    constexpr int dim = 1;
    using HostGridManager = PoreNetworkGridManager<dimWorld>;
    ...
    using SubGridData = PoreNetworkSubGridData<HostGridManager::Grid, SubGridManager::Grid>;
    auto gridData = std::make_shared<SubGridData>(subGridManager.grid(), hostGridData);

    PNMGridGeometry<double, SubGridManager::Grid::LeafGridView> gridGeometry(subGridManager.grid().leafGridView());
