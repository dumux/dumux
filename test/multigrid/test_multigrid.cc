...
void testadaptivity (G& grid, int maxsteps, int modulo, bool globalrefine=false, bool picture=false)
{
    ...
    typedef Dune::GroundwaterEquationLocalStiffness<typename G::LeafGridView,NumberType> LeafLocalStiffness;
    typedef Dune::GroundwaterEquationLocalStiffness<typename G::LevelGridView,NumberType> LevelLocalStiffness;
