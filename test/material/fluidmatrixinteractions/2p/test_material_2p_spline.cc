...
int main(int argc, char** argv) try
{
    ...
    runTest("vg-pc", [](auto sw, const auto& law){ return law.pc(sw); }, vg, vgSpline);
    runTest("vg-dpc", [](auto sw, const auto& law){ return law.dpc_dsw(sw); }, vg, vgSpline);
    runTest("vg-krw", [](auto sw, const auto& law){ return law.krw(sw); }, vg, vgSpline);
    runTest("vg-dkrw", [](auto sw, const auto& law){ return law.dkrw_dsw(sw); }, vg, vgSpline);
    runTest("vg-krn", [](auto sw, const auto& law){ return law.krn(sw); }, vg, vgSpline);
    runTest("vg-dkrn", [](auto sw, const auto& law){ return law.dkrn_dsw(sw); }, vg, vgSpline);

    // inversions
    runTest("vg-sw-i", [](auto sw, const auto& law){ return law.sw(law.pc(sw)); }, vg, vgSpline);
    runTest("vg-dsw-i", [](auto sw, const auto& law){ return law.dsw_dpc(law.pc(sw)); }, vg, vgSpline);
