...
int main(int argc, char** argv) try
{
    ...
    runTest("lin-pc", [](auto sw, const auto& law){ return law.pc(sw); }, lin, linSpline);
    runTest("lin-dpc", [](auto sw, const auto& law){ return law.dpc_dsw(sw); }, lin, linSpline);
    runTest("lin-krw", [](auto sw, const auto& law){ return law.krw(sw); }, lin, linSpline);
    runTest("lin-dkrw", [](auto sw, const auto& law){ return law.dkrw_dsw(sw); }, lin, linSpline);
    runTest("lin-krn", [](auto sw, const auto& law){ return law.krn(sw); }, lin, linSpline);
    runTest("lin-dkrn", [](auto sw, const auto& law){ return law.dkrn_dsw(sw); }, lin, linSpline);

    // inversions
    runTest("lin-sw-i", [](auto sw, const auto& law){ return law.sw(law.pc(sw)); }, lin, linSpline);
    runTest("lin-dsw-i", [](auto sw, const auto& law){ return law.dsw_dpc(law.pc(sw)); }, lin, linSpline);
