...
#include "new_pipecoupleincomp_problem.hh"
...
int main(int argc, char** argv)
{
    try{
        ...
        if (argc != 2) {
            std::cout << "usage: pipe_newcouple_incomp dgffilename/basefilename " << std::endl;
            return 1;
        }
        double tEnd=1.0, dt=1.0;
        ...
        typedef Dune::NewCoupleProblemPipe<Grid, Scalar>   Problem;
