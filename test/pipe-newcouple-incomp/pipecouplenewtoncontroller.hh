 ...
 * \file
 *
 * \brief A newton controller for the Pipe_Couple_Incomp model which is coupled
 *        with a pipe flow.
 */
#ifndef DUMUX_PIPE_COUPLE_NEWTON_CONTROLLER_HH
#define DUMUX_PIPE_COUPLE_NEWTON_CONTROLLER_HH
...
class PipeCoupleNewtonController
    : public NewtonControllerBase<NewtonMethod,
                                  PipeCoupleNewtonController<NewtonMethod> >
{
    typedef PipeCoupleNewtonController<NewtonMethod>     ThisType;
