 ...
 */
#ifndef STUPID_NEWTON_CONTROLLER_HH
#define STUPID_NEWTON_CONTROLLER_HH
        ...
        bool newtonProceed(Function &u)
            {
                ...
                _curPhysicalness = _impl()._physicalness(u);
...
*/                
    ...
    protected:
        ...
        const Implementation &_impl() const
    ...
    //!
    //! Basically the only thing to NewtonControllerBase is that
    //! this class can actually be instanced.
    template <class Model>
