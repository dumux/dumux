 ...
 */
#ifndef STUPID_BOX_JACOBIAN_HH
#define STUPID_BOX_JACOBIAN_HH
...
namespace Stupid
{
    ...
    */
    ...
    class BoxJacobian : public Dune::LocalStiffness<BoxJacobian<Problem, BoxTraitsT, JacobianImp>,
                                                    typename Problem::DomainTraits::Grid,
    ...
    public:
        ...
        void assemble(const Cell &cell, int k = 1)
            {
...
*/
                ...
                assembleBoundaryCondition<TypeTag>(_curCell());
        ...
        template<class TypeTag>
        void assembleBoundaryCondition(const Cell &cell)
            {
                setCurrentCell(cell);
