 ...
 *****************************************************************************/
#ifndef STUPID_BOX_MODEL_HH
#define STUPID_BOX_MODEL_HH

#include <Stupid/Models/Box/BoxJacobian.hh>
#include <Stupid/Auxilary/BasicDomain.hh>
#include <Stupid/Solvers/NewtonMethod.hh>
...
//                Api::require<Api::PwSnBoxDomain>(prob);
        ...
        void update(Scalar &dt, Scalar &nextDt, NewtonController &controller)
            {
                typedef Stupid::NewtonMethod<ThisType, NewtonController> NewtonMethod;
        ...
        void _applyDirichletBoundaries(BoxFunction &u)
            {
                ...
                for (; cellIt != cellEndIt; ++cellIt)
                {
                    ...
                    _localJacobian.template assembleBoundaryCondition<Dune::LeafTag>(cell);
