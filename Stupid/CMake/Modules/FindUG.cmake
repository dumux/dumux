...
StupidAddPathSuffixes("${MyIncludeSuffixes}" "${MyLibSuffixes}" )

StupidFindIncludeDir("ugm.h")
StupidFindExtraIncludeDir("GM_H" "gm.h")

foreach(tmp ${MyUgLibs})
  StupidFindLibrary(${tmp})
endforeach(tmp)

StupidRequiredLibsFound(${MyUgLibs})
