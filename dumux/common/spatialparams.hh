 ...
 * \brief Basic spatial parameters to be used with finite-volume or finite-element schemes.
 */
 ...
 * \ingroup Core
 * \ingroup SpatialParameters
 * \brief The base class for spatial parameters used with finite-volume or finite-element schemes.
 */
...
public:
    ...
    Scalar extrusionFactor(const ElementGeometryView& eGeometryView,
                           const IpData& ipData,
     ...
     */
    template<class IpData, class ElementSolution>
    Scalar temperature(const ElementGeometryView& eGeometryView,
                       const IpData& ipData,
                       const ElementSolution& elemSol) const
    {
        // forward to generic interface
