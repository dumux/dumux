 ...
 *
 */
#ifndef DUMUX_AUTOMATICDIFFERENTIATION_EVALUATION_DYNAMIC_HH
#define DUMUX_AUTOMATICDIFFERENTIATION_EVALUATION_DYNAMIC_HH

#include "evaluation.hh"
#include "admath.hh"

#include <dumux/common/valgrind.hh>
#include <dumux/common/automaticdifferentiation/fastsmallvector.hh>
#include <cmath>
#include <cassert>
#include <cstring>
#include <iostream>
...
Dumux::AutomaticDifferentiation::Evaluation<Scalar, -1, staticSize> constant(int numDerivatives, const Scalar& value)
{ return Dumux::AutomaticDifferentiation::Evaluation<Scalar, -1, staticSize>::createConstant(numDerivatives, value); }

template <class Scalar, unsigned staticSize>
Dumux::AutomaticDifferentiation::Evaluation<Scalar, -1, staticSize> variable(int numDerivatives, const Scalar& value, unsigned idx)
{ return Dumux::AutomaticDifferentiation::Evaluation<Scalar, -1, staticSize>::createVariable(numDerivatives, value, idx); }

} // end namespace Dumux

#endif // DUMUX_AUTOMATICDIFFERENTIATION_DYNAMIC_EVALUATION_HH
