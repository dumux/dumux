 ...
 *
 */
#ifndef DUMUX_AUTOMATICDIFFERENTIATION_EVALUATION_HH
#define DUMUX_AUTOMATICDIFFERENTIATION_EVALUATION_HH
...
public:
    ...
    static Evaluation createBlank(const Evaluation& x DUMUX_UNUSED)
    { return Evaluation(); }
...
namespace Dune {
template <class ValueType, int numVars, unsigned staticSize>
struct FieldTraits<Dumux::AutomaticDifferentiation::Evaluation<ValueType, numVars, staticSize> >
{
public:
    typedef Dumux::AutomaticDifferentiation::Evaluation<ValueType, numVars, staticSize> field_type;
...
#endif // DUMUX_AUTOMATICDIFFERENTIATION_EVALUATION_HH
