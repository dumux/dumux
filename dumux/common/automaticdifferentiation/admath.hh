 ...
 * header file.
 */
#ifndef DUMUX_AUTOMATICDIFFERENTIATION_ADMATH_HH
#define DUMUX_AUTOMATICDIFFERENTIATION_ADMATH_HH

#include "evaluation.hh"

#include <dumux/common/automaticdifferentiation/mathtoolbox.hh>
...
template <class ValueT, int numVars, unsigned staticSize>
struct MathToolbox<Dumux::AutomaticDifferentiation::Evaluation<ValueT, numVars, staticSize> >
{
private:
public:
    typedef ValueT ValueType;
    typedef Dumux::MathToolbox<ValueType> InnerToolbox;
    typedef typename InnerToolbox::Scalar Scalar;
    typedef Dumux::AutomaticDifferentiation::Evaluation<ValueType, numVars, staticSize> Evaluation;
    ...
    { return Dumux::AutomaticDifferentiation::max(arg1, arg2); }

    template <class Arg1Eval, class Arg2Eval>
    static Evaluation min(const Arg1Eval& arg1, const Arg2Eval& arg2)
    { return Dumux::AutomaticDifferentiation::min(arg1, arg2); }

    static Evaluation abs(const Evaluation& arg)
    { return Dumux::AutomaticDifferentiation::abs(arg); }

    static Evaluation tan(const Evaluation& arg)
    { return Dumux::AutomaticDifferentiation::tan(arg); }

    static Evaluation atan(const Evaluation& arg)
    { return Dumux::AutomaticDifferentiation::atan(arg); }

    static Evaluation atan2(const Evaluation& arg1, const Evaluation& arg2)
    { return Dumux::AutomaticDifferentiation::atan2(arg1, arg2); }
    ...
    { return Dumux::AutomaticDifferentiation::sin(arg); }

    static Evaluation asin(const Evaluation& arg)
    { return Dumux::AutomaticDifferentiation::asin(arg); }

    static Evaluation cos(const Evaluation& arg)
    { return Dumux::AutomaticDifferentiation::cos(arg); }

    static Evaluation acos(const Evaluation& arg)
    { return Dumux::AutomaticDifferentiation::acos(arg); }

    static Evaluation sqrt(const Evaluation& arg)
    { return Dumux::AutomaticDifferentiation::sqrt(arg); }

    static Evaluation exp(const Evaluation& arg)
    { return Dumux::AutomaticDifferentiation::exp(arg); }

    static Evaluation log(const Evaluation& arg)
    { return Dumux::AutomaticDifferentiation::log(arg); }

    template <class RhsValueType>
    static Evaluation pow(const Evaluation& arg1, const RhsValueType& arg2)
    { return Dumux::AutomaticDifferentiation::pow(arg1, arg2); }
