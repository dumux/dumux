 ...
 */
#ifndef DUMUX_MATH_TOOLBOX_HH
#define DUMUX_MATH_TOOLBOX_HH
...
public:
     ...
     */
    typedef Dumux::MathToolbox<Scalar> InnerToolbox;
     ...
     */
    static Scalar createBlank(Scalar value DUMUX_UNUSED)
    { return Scalar(); }
...
{ return Dumux::MathToolbox<Evaluation>::createBlank(x); }

template <class Evaluation, class Scalar>
Evaluation constant(const Scalar& value)
{ return Dumux::MathToolbox<Evaluation>::createConstant(value); }

template <class Evaluation, class Scalar>
Evaluation variable(const Scalar& value, unsigned idx)
{ return Dumux::MathToolbox<Evaluation>::createVariable(value, idx); }

template <class ResultEval, class Evaluation>
auto decay(const Evaluation& value)
    -> decltype(Dumux::MathToolbox<Evaluation>::template decay<ResultEval>(value))
{ return Dumux::MathToolbox<Evaluation>::template decay<ResultEval>(value); }

template <class Evaluation>
auto getValue(const Evaluation& val)
    -> decltype(Dumux::MathToolbox<Evaluation>::value(val))
{ return Dumux::MathToolbox<Evaluation>::value(val); }

template <class Evaluation>
auto scalarValue(const Evaluation& val)
    -> decltype(Dumux::MathToolbox<Evaluation>::scalarValue(val))
{ return Dumux::MathToolbox<Evaluation>::scalarValue(val); }
...
{ return Dumux::MathToolbox<typename ReturnEval_<Evaluation1, Evaluation2>::type>::max(arg1, arg2); }

template <class Evaluation1, class Evaluation2>
typename ReturnEval_<Evaluation1, Evaluation2>::type
min(const Evaluation1& arg1, const Evaluation2& arg2)
{ return Dumux::MathToolbox<typename ReturnEval_<Evaluation1, Evaluation2>::type>::min(arg1, arg2); }

template <class Evaluation>
Evaluation abs(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::abs(value); }

template <class Evaluation>
Evaluation tan(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::tan(value); }

template <class Evaluation>
Evaluation atan(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::atan(value); }

template <class Evaluation1, class Evaluation2>
typename ReturnEval_<Evaluation1, Evaluation2>::type
atan2(const Evaluation1& value1, const Evaluation2& value2)
{ return Dumux::MathToolbox<typename ReturnEval_<Evaluation1, Evaluation2>::type>::atan2(value1, value2); }

template <class Evaluation>
Evaluation sin(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::sin(value); }

template <class Evaluation>
Evaluation asin(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::asin(value); }

template <class Evaluation>
Evaluation cos(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::cos(value); }

template <class Evaluation>
Evaluation acos(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::acos(value); }

template <class Evaluation>
Evaluation sqrt(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::sqrt(value); }

template <class Evaluation>
Evaluation exp(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::exp(value); }

template <class Evaluation>
Evaluation log(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::log(value); }

template <class Evaluation1, class Evaluation2>
typename ReturnEval_<Evaluation1, Evaluation2>::type
pow(const Evaluation1& base, const Evaluation2& exp)
{ return Dumux::MathToolbox<typename ReturnEval_<Evaluation1, Evaluation2>::type>::pow(base, exp); }

template <class Evaluation>
bool isfinite(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::isfinite(value); }

template <class Evaluation>
bool isnan(const Evaluation& value)
{ return Dumux::MathToolbox<Evaluation>::isnan(value); }
