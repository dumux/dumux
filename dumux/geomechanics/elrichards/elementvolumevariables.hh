 ...
 */
#ifndef DUMUX_BOX_ELRICHARDS_ELEMENT_VOLUME_VARIABLES_HH
#define DUMUX_BOX_ELRICHARDS_ELEMENT_VOLUME_VARIABLES_HH
...
class ElRichardsElementVolumeVariables : public std::vector<typename GET_PROP_TYPE(TypeTag, VolumeVariables) >
{
    ...
    typedef typename GET_PROP_TYPE(TypeTag, Indices) Indices;
        enum {
            pressureIdx = Indices::pwIdx, //pwIdx is defined in richards/indices as Primary variable index for the wetting phase pressure
            //saturationIdx = Indices::saturationIdx //was not declared for richards
        };
...
public:
     ...
     */
    ElRichardsElementVolumeVariables()
    { }
