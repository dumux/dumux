 ...
 */
#ifndef DUMUX_ELASTICRICHARDS_BASE_MODEL_HH
#define DUMUX_ELASTICRICHARDS_BASE_MODEL_HH
 ...
 * \brief base class for the richards geomechanics model
 */
template<class TypeTag>
class ElRichardsBaseModel
{
    ...
    ElRichardsBaseModel(const ElRichardsBaseModel &);
