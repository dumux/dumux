...
//                else
                ...
                effectivePressure[eIdx] += (pn[vIdxGlobal] * sn[vIdxGlobal]
                                            ...
                                            / numScv;
//                 std::cout<< "pn="<<pn[vIdxGlobal] << std::endl;
//                 std::cout<< "sn="<<sn[vIdxGlobal] << std::endl;
//                 std::cout<< "pw="<<pw[vIdxGlobal] << std::endl;
//                  std::cout<< "sw="<<sw[vIdxGlobal] << std::endl;
...
//             Scalar S0 = 0.0;
            ...
            Scalar Phi = GET_RUNTIME_PARAM(TypeTag, Scalar, TransportParameters.Phi);//khodam
            Scalar swr = GET_RUNTIME_PARAM(TypeTag, Scalar, TransportParameters.swr);//khodam
