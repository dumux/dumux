 ...
 */
#ifndef DUMUX_DECOUPLED_ELASTIC_ASSEMBLER_HH
#define DUMUX_DECOUPLED_ELASTIC_ASSEMBLER_HH
...
class DecoupledElasticAssembler
{
    ...
    typedef typename GET_PROP_TYPE(TypeTag, GridFunctionSpace) DisplacementGFS;
    ...
    DecoupledElasticAssembler(const DecoupledElasticAssembler &);
...
public:
    ...
    void init(Problem& problem)
    {
        ...
        gridFunctionSpace_ = std::make_shared<GridFunctionSpace>(*displacementScalarGFS_);
