...
#define PROP_INFO_(EffTypeTag, PropTag)                     \
    template <>                                             \
    struct PropertyInfo< EffTypeTag, PropTag>               \
    {                                                       \
...
#define NEW_TYPE_TAG(TypeTagName, ...)                              \
    ...
    {                                                               \
        static const char *name() { return #TypeTagName ;};         \
    };                                                              \
    };
 ...
 */
#define TTAG(TypeTagName)  ::Dune::Properties::TTag::TypeTagName

/*! 
 * \brief Makes a type out of a property tag name
 */
#define PTAG(PropTagName)  ::Dune::Properties::PTag::PropTagName
...
#define SET_PROP(EffTypeTagName, PropTagName)                   \
    ...
    struct Property<TypeTag,                                    \
                    Dune::Properties::TTag:: EffTypeTagName,    \
                    Dune::Properties::PTag:: PropTagName>;      \
    PROP_INFO_(Dune::Properties::TTag:: EffTypeTagName,         \
               Dune::Properties::PTag:: PropTagName);           \
    template <class TypeTag>                                    \
    struct Property<TypeTag,                                    \
                    Dune::Properties::TTag:: EffTypeTagName,    \
...
#define SET_PROP_DEFAULT(PropTagName)                                   \
    ...
    PROP_INFO_(void, PTAG(PropTagName));                                \
    template <class TypeTag>                                            \
    struct DefaultProperty<TypeTag, PTAG(PropTagName) >
...
#define UNSET_PROP(EffTypeTagName, PropTagName)                 \
    ...
    {};                                                         \
    PROP_INFO_(TTAG(EffTypeTagName),                            \
               PTAG(PropTagName));
...
#define GET_PROP(TypeTag, PropTag)              \
    ::Dune::Properties::GetProperty< TypeTag, PropTag>::p
...
#define GET_PROP_VALUE(TypeTag, PropTag)  \
    ::Dune::Properties::GetProperty< TypeTag, PropTag>::p::value
...
#define GET_PROP_TYPE(TypeTag, PropTag)          \
    ::Dune::Properties::GetProperty< TypeTag, \
                                     PropTag>::p::type
...
#define PROP_DIAGNOSTIC(TypeTag, PropTag)       \
    ::Dune::Properties::propertyDiagnostic< TypeTag, \
                                            TypeTag, \
                                            PropTag>::message()
#else
/*!
