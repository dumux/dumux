...
*/
template<class G, class RT, int m, class VtkMultiWriter>
class BoxMincCO2
    : public LeafP1TwoPhaseModel<G, RT, TwoPTwoCNIProblem<G, RT, m>, BoxMincCO2Jacobian<G, RT, m>, m >
{
public:
    // define the problem type (also change the template argument above)
    typedef TwoPTwoCNIProblem<G, RT, m> ProblemType;

    // define the local Jacobian (also change the template argument above)
    typedef BoxMincCO2Jacobian<G, RT, m> LocalJacobian;
    typedef LeafP1TwoPhaseModel<G, RT, ProblemType, LocalJacobian, m> ThisLeafP1TwoPhaseModel;
    typedef BoxMincCO2<G, RT, m, VtkMultiWriter> ThisType;
