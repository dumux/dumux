 ...
 * \file
 * \ingroup DumuxPython
 * \brief A problem definiton for a OnePTpfa
 */

#ifndef DUMUX_POROUSMEDIUMFLOW_PY_ONEPPROBLEM_HH
#define DUMUX_POROUSMEDIUMFLOW_PY_ONEPPROBLEM_HH
...
#include <dumux/porousmediumflow/py/onepspatialparams.hh>
