...
: public DiscretizationDefaultLocalOperator<TypeTag, ImmiscibleLocalResidual<TypeTag>, GetPropType<TypeTag, Properties::GridGeometry>>
{
    using GridGeometry = GetPropType<TypeTag, Properties::GridGeometry>;
    using ThisType = ImmiscibleLocalResidual<TypeTag>;
    using ParentType = DiscretizationDefaultLocalOperator<TypeTag, ThisType, GridGeometry>;
