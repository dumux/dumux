 ...
 * \f$ \cdot \f$ \f$ \bf D_{w,pm}^{k} \f$ is the diffusivity of component \f$ \kappa \f$ in the wetting phase, <br>
 * \f$ \cdot \f$ \f$ X_w^k \f$ is the mass fraction of component \f$ \kappa \f$ in the wetting phase, <br>
