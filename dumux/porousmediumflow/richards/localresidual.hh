...
: public DiscretizationDefaultLocalOperator<TypeTag, RichardsLocalResidual<TypeTag>, GetPropType<TypeTag, Properties::GridGeometry>>
{
    using GridGeometry = GetPropType<TypeTag, Properties::GridGeometry>;
    using ParentType = DiscretizationDefaultLocalOperator<TypeTag, RichardsLocalResidual<TypeTag>, GridGeometry>;
