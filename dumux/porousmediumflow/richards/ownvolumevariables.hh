...
public:
                            ...
                            SolidState& solidState)
    {
        ...
        using std::max;
        const Scalar pc = problem.nonwettingReferencePressure() - fluidState.pressure(FluidSystem::liquidPhaseIdx);
    ...
    {
        return pressure(FluidSystem::gasPhaseIdx) - pressure(FluidSystem::liquidPhaseIdx);
    }
