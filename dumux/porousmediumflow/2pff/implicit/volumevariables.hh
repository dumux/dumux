 ...
 */
#ifndef DUMUX_2P_FRACFLOW_VOLUME_VARIABLES_HH
#define DUMUX_2P_FRACFLOW_VOLUME_VARIABLES_HH
...
class TwoPFractionalFlowVolumeVariables : public ImplicitVolumeVariables<TypeTag>
{
