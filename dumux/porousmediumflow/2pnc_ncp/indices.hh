...
#ifndef DUMUX_2PNC_NCP_INDICES_HH
#define DUMUX_2PNC_NCP_INDICES_HH
...
struct TwoPNCNCPIndices
{
    ...
    static constexpr int saturationIdx = 1;   //! index of either the saturation

    // index of the first component
    static constexpr int comp0Idx = 2; //! index of the conservation equation for the first component

    // index of the first component
    static constexpr int conti0EqIdx = 2; //!
    static const unsigned int phase0NcpIdx = 0;
};
