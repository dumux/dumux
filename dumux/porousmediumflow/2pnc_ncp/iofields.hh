...
#ifndef DUMUX_TWOP_NC_NCP_IO_FIELDS_HH
#define DUMUX_TWOP_NC_NCP_IO_FIELDS_HH
...
/*!
 * \ingroup TwoPNCNCPModel
 * \brief Adds I/O fields specific to the TwoPNCNCP model.
 */
class TwoPNCNCPIOFields
{
public:
