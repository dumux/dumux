...
#ifndef DUMUX_2PNC_NCP_VOLUME_VARIABLES_HH
#define DUMUX_2PNC_NCP_VOLUME_VARIABLES_HH
...
class TwoPNCNCPVolumeVariables
: public PorousMediumFlowVolumeVariables<Traits>
, public EnergyVolumeVariables<Traits, TwoPNCNCPVolumeVariables<Traits> >
{
    using ParentType = PorousMediumFlowVolumeVariables<Traits>;
    using EnergyVolVars = EnergyVolumeVariables<Traits, TwoPNCNCPVolumeVariables<Traits> >;
...
public:
    ...
    */
                            ...
                            SolidState& solidState)
    {
        ...
        // now comes the tricky part: calculate phase composition. As one phase is already known, calculate only the other phase in reference to that composition.
        ...
        {
                fluidState.setMoleFraction(knownPhaseIdx, compIdx, priVars[2+compIdx]);
        }
