...
#ifndef DUMUX_2PNC_NCP_PRIMARY_VARIABLE_SWITCH_HH
#define DUMUX_2PNC_NCP_PRIMARY_VARIABLE_SWITCH_HH
 ...
 */
class TwoPNCNCPPrimaryVariableSwitch
: public PrimaryVariableSwitch<TwoPNCNCPPrimaryVariableSwitch>
{
    using ParentType = PrimaryVariableSwitch<TwoPNCNCPPrimaryVariableSwitch>;
    friend ParentType;
public:
