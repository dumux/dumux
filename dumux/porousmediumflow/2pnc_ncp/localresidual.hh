 ...
 * \brief TwoPNCNCP specific details needed to approximately calculate the local
 *        defect in the fully implicit scheme.
 */

#ifndef DUMUX_2PNC_NCP_LOCAL_RESIDUAL_HH
#define DUMUX_2PNC_NCP_LOCAL_RESIDUAL_HH
...
class TwoPNCNCPLocalResidual : public CompositionalLocalResidual<TypeTag>
{
...
public:
                                            ...
                                            const ElementBoundaryTypes &bcTypes) const
    {
        ...
        {
            // here we need to set the constraints of the TwoPNCNCP model into the residual
