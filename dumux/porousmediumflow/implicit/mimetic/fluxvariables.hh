 ...
 */
#ifndef DUMUX_POROUSMEDIUMFLOW_IMPLICIT_MIMETIC_FLUXVARIABLES_HH
#define DUMUX_POROUSMEDIUMFLOW_IMPLICIT_MIMETIC_FLUXVARIABLES_HH

#include <dumux/implicit/properties.hh>
#include <dumux/discretization/staggered/mimetic/fluxvariablesbase.hh>
...
class PorousMediumFluxVariablesMimeticImpl;
...
using PorousMediumFluxVariablesMimetic = PorousMediumFluxVariablesMimeticImpl<TypeTag, GET_PROP_VALUE(TypeTag, EnableAdvection),
...
template<class TypeTag>
class PorousMediumFluxVariablesMimeticImpl<TypeTag, true, false, false> : public FluxVariablesBaseMimetic<TypeTag>
{
    using ParentType = FluxVariablesBaseMimetic<TypeTag>;
...
template<class TypeTag>
class PorousMediumFluxVariablesMimeticImpl<TypeTag, true, true, false> : public FluxVariablesBaseMimetic<TypeTag>
{
    using ParentType = FluxVariablesBaseMimetic<TypeTag>;
    using Problem = typename GET_PROP_TYPE(TypeTag, Problem);
    using GridView = typename GET_PROP_TYPE(TypeTag, GridView);
...
public:
    //! The constructor
    PorousMediumFluxVariablesMimeticImpl()
    {
...
template<class TypeTag>
class PorousMediumFluxVariablesMimeticImpl<TypeTag, true, false, true> : public FluxVariablesBaseMimetic<TypeTag>
{
    using ParentType = FluxVariablesBaseMimetic<TypeTag>;
    using Problem = typename GET_PROP_TYPE(TypeTag, Problem);
    using GridView = typename GET_PROP_TYPE(TypeTag, GridView);
...
template<class TypeTag>
class PorousMediumFluxVariablesMimeticImpl<TypeTag, true, true, true> : public FluxVariablesBaseMimetic<TypeTag>
{
    using ParentType = FluxVariablesBaseMimetic<TypeTag>;
    using Problem = typename GET_PROP_TYPE(TypeTag, Problem);
    using GridView = typename GET_PROP_TYPE(TypeTag, GridView);
