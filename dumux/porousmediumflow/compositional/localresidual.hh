...
: public DiscretizationDefaultLocalOperator<TypeTag, CompositionalLocalResidual<TypeTag>, GetPropType<TypeTag, Properties::GridGeometry>>
{
    using GridGeometry = GetPropType<TypeTag, Properties::GridGeometry>;
    using ParentType = DiscretizationDefaultLocalOperator<TypeTag, CompositionalLocalResidual<TypeTag>, GridGeometry>;
