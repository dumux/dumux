...
#ifndef DUMUX_ONEP_TWOC_ADSORPTION_LOCAL_RESIDUAL_HH
#define DUMUX_ONEP_TWOC_ADSORPTION_LOCAL_RESIDUAL_HH
...
class OnePTwoCAdsorptionLocalResidual : public GET_PROP_TYPE(TypeTag, BaseLocalResidual)
{
protected:
...
public:
     ...
     */
    OnePTwoCAdsorptionLocalResidual()
    {
    ...
    void computeStorage(PrimaryVariables &storage, const int scvIdx, const bool usePrevSol) const
    {
        ...
        if(useMoles) // mole-fraction formulation
        {
            ...
            storage[transportEqIdx] += volVars.molarDensity()
                    ...
                    * volVars.porosity()
                    + volVars.adsorption(transportCompIdx);
        }
