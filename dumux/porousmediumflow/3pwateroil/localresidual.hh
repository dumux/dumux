...
: public DiscretizationDefaultLocalOperator<TypeTag, ThreePWaterOilLocalResidual<TypeTag>, GetPropType<TypeTag, Properties::GridGeometry>>
{
protected:
    using GridGeometry = GetPropType<TypeTag, Properties::GridGeometry>;
    using ParentType = DiscretizationDefaultLocalOperator<TypeTag, ThreePWaterOilLocalResidual<TypeTag>, GridGeometry>;
