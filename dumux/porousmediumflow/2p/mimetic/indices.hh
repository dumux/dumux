 ...
 */
#ifndef DUMUX_MIMETIC_2P_INDICES_HH
#define DUMUX_MIMETIC_2P_INDICES_HH
...
struct TwoPMimeticCommonIndices
{
    ...
    static constexpr int faceFluxBalanceWIdx = contiWEqIdx + faceOffset;
    static constexpr int faceFluxBalanceNIdx = contiNEqIdx + faceOffset;
    static constexpr int facePressureWIdx = faceFluxBalanceWIdx;
    static constexpr int facePressureNIdx = faceFluxBalanceNIdx;
};
...
template <class TypeTag,
          int formulation = TwoPMimeticFormulation::pwsn,
          int PVOffset = 0>
struct TwoPMimeticIndices
: public TwoPMimeticCommonIndices<TypeTag, PVOffset>, TwoPMimeticFormulation
{
...
struct TwoPMimeticIndices<TypeTag, TwoPMimeticFormulation::pnsw, PVOffset>
: public TwoPMimeticCommonIndices<TypeTag, PVOffset>, TwoPMimeticFormulation
{
    // indices of the primary variables
