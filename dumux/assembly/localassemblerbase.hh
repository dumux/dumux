 ...
 * \tparam useImplicitAssembly Specifies whether the time discretization is implicit or not (i.e. explicit)
 */
...
public:
     ...
     *        Automatically chooses the appropriate element variables.
     */
