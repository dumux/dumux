...
#include <dumux/common/typetraits/boundary.hh>
...
public:
    ...
    void evalDirichletBoundaries(ApplyDirichletFunctionType applyDirichlet)
    {
        ...
        // this is replaced by constraints when having the new boundary interface
        if constexpr (!Detail::hasProblemNewBoundaryTypesFunction<Problem, FVElementGeometry, typename GridGeometry::GridView::Intersection>())
        {
