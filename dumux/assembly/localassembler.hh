...
template<class LO,
         DiscretizationMethod dm = LO::LocalContext::ElementGridGeometry::GridGeometry::discMethod>
...
using LocalAssembler = typename Detail::LocalAssemblerChooser<LocalOperator>::type;
