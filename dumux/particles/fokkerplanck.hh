 ...
 * \f]
 *
 * Particles are evoled with the \ref Dumux::Particles::FokkerPlanck::run method,
 ...
 *
 * The following shows an example solving the Fokker-Planck equation
 * in a 1D domain starting with all particles at the center of the domain.
 *
...
private:
    ...
    GlobalPosition bBoxMin_, bBoxMax_;
    std::array<int, dimWorld> cells_;
};
