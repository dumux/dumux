...
#include "dumux/diffusion/fv/fvdiffusion_pn.hh"
...
//                        lambda=lambdaJ;
                    ...
                    vTotal *= (lambda*(pressgrad-pcgrad));
                ...
                else
                {
                    ...
                    if (bctype == BoundaryConditions::dirichlet) {
                        ...
                        double pcj = this->diffproblem.materialLaw.pC(this->diffproblem.gSat(faceglobal, *it, facelocalDim));
