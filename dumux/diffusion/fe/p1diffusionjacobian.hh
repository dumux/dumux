...
#ifndef DUNE_P1DIFFUSIONJACOBIAN_HH
#define DUNE_P1DIFFUSIONJACOBIAN_HH
...
class P1DiffusionLocalJacobian
    : public LocalJacobian<P1DiffusionLocalJacobian<G,RT>,G,RT,1>
{
    template<int dim>
...
public:
    ...
    //! Constructor
    P1DiffusionLocalJacobian (DiffusionProblem<G,RT>& params,
                              bool levelBoundaryAsDirichlet_, const G& grid,
                              const P1Function& sol,
