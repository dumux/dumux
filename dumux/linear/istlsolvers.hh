...
public:
                     ...
                     const std::string& paramGroup = "")
    {
        initializeParameters_(paramGroup);
#if HAVE_MPI
        solverCategory_ = Impl::solverCategory<LinearSolverTraits>(gridView);
    ...
    {
        initializeParameters_(paramGroup);
        solverCategory_ = Impl::solverCategory(gridView);
...
using ILUBiCGSTABIstlSolver = IstlLinearSolver<LinearSolverTraits,
                                               ...
                                               Dune::SeqILU<Matrix, Vector, Vector, Impl::preconditionerBlockLevel<Matrix>()>
                                               >;
