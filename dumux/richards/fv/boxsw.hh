...
class BoxSw
: public LeafP1TwoPhaseModel<Grid, Scalar, RichardsProblem<Grid, Scalar>, BoxSwJacobian<Grid, Scalar> >
{
...
public:
	...
	typedef BoxSwJacobian<Grid, Scalar> LocalJacobian;
	...
	typedef BoxSw<Grid, Scalar> ThisType;
	...
	BoxSw(const Grid& g, ProblemType& prob)
