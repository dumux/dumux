 ...
 */
template<class Grid, class Scalar, class VC, class CoarseScaleParameters>
class FractionalFlowMSProblem
{
public:
    enum
...
public:
    ...
    */
    ...
    virtual CoarseScaleParameters& coarseScaleParameters () const
    {
        return coarseParameters_;
    }
     ...
     */
    FractionalFlowMSProblem(VC& variables, Fluid& wettingphase, Fluid& nonwettingphase, Matrix2p<Grid, Scalar>& soil, CoarseScaleParameters& coarseParams, TwoPhaseRelations<Grid, Scalar>& materialLaw = *(new TwoPhaseRelations<Grid,Scalar>), const bool capillarity = false)
        : variables(variables), wettingPhase(wettingphase), nonWettingPhase(nonwettingphase), soil_(soil), capillarity(capillarity), coarseParameters_(coarseParams), materialLaw_(materialLaw), gravity_(0)
    {}

    //! always define virtual destructor in abstract base class
    virtual ~FractionalFlowMSProblem ()
    {}
    ...
    CoarseScaleParameters& coarseParameters_;
