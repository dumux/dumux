...
public:
    ...
    struct Traits
    {
        ...
        //! maps to n-dimensional elements the set of (n+1)-dimensional elements in which they are embedded
    ...
    //! export the grid id of the bulk grid (always zero <- descending grid dim)
