...
public:
                ...
                bool verbose = false)
    {
        ...
        this->vertexMapper().enrich(facetGridView, facetGridIndexAdapter, verbose);
        ...
        for (const auto& element : elements(this->gridView()))
        {
            ...
            for (const auto& intersection : intersections(this->gridView(), element))
            {
                ...
                const bool isOnFacet = std::all_of( vIndicesLocal.begin(),
                                                    vIndicesLocal.end(),
                                                    [&] (auto vIdxLocal) { return facetGridIndexAdapter.isOnFacetGrid(element.template subEntity<dim>(vIdxLocal)); } );
