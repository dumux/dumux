 ...
 * \ingroup MultiDomain
 * \brief An assembler for Jacobian and residual contribution per element (control-volume fe methods) for multidomain problems
 */
#ifndef DUMUX_MULTIDOMAIN_CVFE_LOCAL_ASSEMBLER_HH
#define DUMUX_MULTIDOMAIN_CVFE_LOCAL_ASSEMBLER_HH
 ...
 * \ingroup MultiDomain
 * \brief A base class for all cvfe staggered local assemblers
 ...
 * \ingroup CvfeDiscretization
 * \ingroup MultiDomain
 * \brief The cvfe staggered scheme multidomain local assembler
 * \tparam id the id of the sub domain
 * \tparam TypeTag the TypeTag
 * \tparam Assembler the assembler type
...
: public SubDomainCvfeLocalAssemblerBase<id, TypeTag, Assembler,
             SubDomainCvfeLocalAssembler<id, TypeTag, Assembler, DiffMethod::numeric, true>, DiffMethod::numeric, /*implicit=*/true>
{
