 ...
 * \file
 * \ingroup MultiDomain
 * \copydoc Dumux::GenericCouplingManager
 */

#ifndef DUMUX_MULTIDOMAIN_GENERIC_COUPLINGMANAGER_HH
#define DUMUX_MULTIDOMAIN_GENERIC_COUPLINGMANAGER_HH
