...
using StokesDarcyCouplingData = StokesDarcyCouplingDataImplementation<MDTraits, CouplingManager,
                                                                      GetPropType<typename MDTraits::template SubDomain<CouplingManager::stokesIdx>::TypeTag, Properties::ModelTraits>::enableEnergyBalance(),
                                                                      (GetPropType<typename MDTraits::template SubDomain<CouplingManager::stokesIdx>::TypeTag, Properties::ModelTraits>::numFluidComponents() > 1),
                                                                      GetPropType<typename MDTraits::template SubDomain<CouplingManager::darcyIdx>::TypeTag, Properties::GridGeometry>::discMethod>;
