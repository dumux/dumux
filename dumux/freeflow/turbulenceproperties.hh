...
#ifndef DUMUX_FREEFLOW_TURBULENCE_PROPERTIES_HH
#define DUMUX_FREEFLOW_TURBULENCE_PROPERTIES_HH
 ...
 *        e.g. for setting up inflow boundary conditions for a RANS turbulence model.
 */
...
public:
     ...
     *        in the ANSYS Fluent user guide
     */
    ...
    /*!
     * \brief Estimates the viscosity tilde (Spalart-Allmaras working variable)
     *        based on a formula given in the ANSYS Fluent user guide
     */
