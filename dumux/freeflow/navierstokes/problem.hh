...
template<class TypeTag>
class NavierStokesProblemImpl<TypeTag, DiscretizationMethods::FCDiamond> : public FVProblem<TypeTag>
{
...
template<class TypeTag>
class NavierStokesProblemImpl<TypeTag, DiscretizationMethods::Box>
: public NavierStokesProblemImpl<TypeTag, DiscretizationMethods::CCTpfa>
{
