 ...
 */
#ifndef DUMUX_NAVIERSTOKES_MASS_AND_ENERGY_LOCAL_RESIDUAL_HH
#define DUMUX_NAVIERSTOKES_MASS_AND_ENERGY_LOCAL_RESIDUAL_HH
...
class NavierStokesMassAndEnergyResidual : public CCLocalResidual<TypeTag>
{
