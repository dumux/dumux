...
public:
    ...
    NumEqVector frontalDiffusiveMomentumFlux() const
    {
        ...
        const auto mu = this->problem().effectiveViscosity(this->element(), fvGeometry, scvf, elemVolVars);
    ...
    NumEqVector pressureContribution() const
    {
        ...
        //                         this->problem().analyticalSolution(scvf.ipGlobal())[scvf.directionIndex()] - this->problem.initial(scv)[Indices::pressureIdx] // TODO problem signatures
        //                       : this->problem().analyticalSolution(scvf.ipGlobal())[scvf.directionIndex()];
