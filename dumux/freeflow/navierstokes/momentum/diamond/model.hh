...
struct NormalizePressure<TypeTag, TTag::NavierStokesMomentumDiamond> { static constexpr bool value = true; }; //!< Normalize the pressure term in the momentum balance by default
...
//! The local residual
template<class TypeTag>
struct LocalResidual<TypeTag, TTag::NavierStokesMomentumDiamond> { using type = NavierStokesMomentumDiamondResidual<TypeTag>; };
...
//! The flux variables
template<class TypeTag>
struct FluxVariables<TypeTag, TTag::NavierStokesMomentumDiamond> { using type = NavierStokesMomentumDiamondFluxVariables<TypeTag>; };

template<class TypeTag>
struct FluxVariablesCache<TypeTag, TTag::NavierStokesMomentumDiamond> { using type = FluxVariablesCaching::EmptyCache<GetPropType<TypeTag, Properties::Scalar>>; };

template<class TypeTag>
struct FluxVariablesCacheFiller<TypeTag, TTag::NavierStokesMomentumDiamond> { using type = FluxVariablesCaching::EmptyCacheFiller; };
