 ...
 */
#ifndef DUMUX_NAVIERSTOKES_MOMENTUM_PQ1BUBBLE_FLUXVARIABLES_HH
#define DUMUX_NAVIERSTOKES_MOMENTUM_PQ1BUBBLE_FLUXVARIABLES_HH
...
using NavierStokesMomentumFluxContextPQ1Bubble = NavierStokesMomentumFluxContext<Problem, FVElementGeometry, ElementVolumeVariables, ElementFluxVariablesCache>;

/*!
 * \ingroup NavierStokesModel
 * \brief The flux variables class for the Navier-Stokes model using the pq1bubble grid discretization
 */
template<class GridGeometry, class NumEqVector>
class NavierStokesMomentumFluxPQ1Bubble
{
