 ...
 * \file
 * \ingroup TwoEqModel
 * \copydoc Dumux::TwoEqIndices
 */
#ifndef DUMUX_TURBULENCE_TWO_EQ_INDICES_HH
#define DUMUX_TURBULENCE_TWO_EQ_INDICES_HH
...
struct TwoEqIndices : public NavierStokesMassOnePIndices
{
public:
    static constexpr auto turbulentKineticEnergyEqIdx = numComponents;
