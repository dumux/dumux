...
public:
    ...
    void updateStaticWallProperties()
    {
        ...
        getTurbulenceModel_ = getParam<std::string>("RANS.TurbulenceModel");
    ...
    void updateDynamicWallProperties(const SolutionVector& curSol)
    {
        ...
        for (const auto& element : elements(this->gridGeometry().gridView()))
        {
            ...
            for (auto&& scv : scvs(fvGeometry))
            {
                ...
                const std::string turbulenceModel = readInTurbulenceModel();
    ...
    std::string readInTurbulenceModel() const
    { return getTurbulenceModel_; }
...
private:
    ...
    std::string getTurbulenceModel_;
