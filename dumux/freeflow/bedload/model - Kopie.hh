 ...
 *
 * \brief A bulk bedload transport model
 *
 ...
 * $\text{n+1}$ and $\text{n}$ denote the new and the old time levels, \f$ \rho_s \f$ the grain denisty.
 * The unit outward normal vector is designated as \f$ mathbf{n} \f$, and the length of a face is referred to as \f$ l \f$.
 * The index \f$ k \f$ denotes the corresponding face. Consequently, \f$ q_{b,k} \f$ denote the flux at the face k.
