...
: public DiscretizationDefaultLocalOperator<TypeTag, ShallowWaterResidual<TypeTag>, GetPropType<TypeTag, Properties::GridGeometry>>
{
    using GridGeometry = GetPropType<TypeTag, Properties::GridGeometry>;
    using ParentType = DiscretizationDefaultLocalOperator<TypeTag, ShallowWaterResidual<TypeTag>, GridGeometry>;
