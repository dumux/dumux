 ...
 * \brief Adds I/O fields specific to the advection diffusion transport model.
 */

#ifndef DUMUX_ADVECTION_DIFFUSION_IO_FIELDS_HH
#define DUMUX_ADVECTION_DIFFUSION_IO_FIELDS_HH
 ...
 * \brief Adds I/O fields specific to the advection diffusion transport model.
 */
class AdvectionDiffusionIOFields
{
public:
