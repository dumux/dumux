...
/*!
 * \file
 * \brief An elastic deformation specific controller for the newton solver.
 *
 * This controller 'knows' what a 'physically meaningful' solution is
 * which allows the newton method to abort quicker if the solution is
 * way out of bounds.
 */
#ifndef DUMUX_ELASTIC_NEWTON_CONTROLLER_HH
#define DUMUX_ELASTIC_NEWTON_CONTROLLER_HH
...
class ElasticNewtonController: public NewtonControllerBase<NewtonMethod,
        ElasticNewtonController<NewtonMethod> >
{
typedef        typename NewtonMethod::Model Model;
        ...
        public:
        typedef ElasticNewtonController<NewtonMethod> ThisType;
        ...
        ElasticNewtonController(Scalar tolerance = 1e-7,
                int targetSteps = 9,
                int maxSteps = 18)
