...
#ifndef DUMUX_2P_DFM_PROPERTIES_HH
#define DUMUX_2P_DFM_PROPERTIES_HH
...
NEW_TYPE_TAG(BoxTwoPDFM, INHERITS_FROM(BoxTwoP));
...
NEW_PROP_TAG(TwoPDFMIndices); //!< DEPRECATED Enumerations for the 2p models
