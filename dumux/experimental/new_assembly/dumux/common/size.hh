...
/*!
 * \ingroup Common
 * \brief Type to represent dynamic container sizes.
 *        Can be used in contexts were both reserved and dynamic container sizes
 *        are supported. Any arithmetic operations to "compute" a container size
 *        from multiple values yield a dynamic size again.
 */
struct Dynamic
{
