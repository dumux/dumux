...
private:
                                   ...
                                   const PartialReassembler* partialReassembler = nullptr)
    {
        ...
        auto variablesContext = Dumux::Detail::CVFE::makeVariablesContext(
        ...
        auto deflectionPolicy = Dumux::Detail::CVFE::VariablesDeflectionPolicy(variablesContext, fvGeometry);
