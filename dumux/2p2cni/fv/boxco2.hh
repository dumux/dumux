 ...
 */
 template<class ThisGrid, class ThisScalar, class VtkMultiWriter>
  class BoxCO2
  : public LeafP1TwoPhaseModel<ThisGrid, ThisScalar, TwoPTwoCNIProblem<ThisGrid, ThisScalar>, BoxCO2Jacobian<ThisGrid, ThisScalar> >
  {
  public:
    ...
    typedef BoxCO2Jacobian<ThisGrid, ThisScalar> LocalJacobian;
    typedef LeafP1TwoPhaseModel<ThisGrid, ThisScalar, ProblemType, LocalJacobian> ThisLeafP1TwoPhaseModel;
    typedef BoxCO2<ThisGrid, ThisScalar, VtkMultiWriter> ThisType;
    ...
    BoxCO2(const ThisGrid& grid, ProblemType& prob)
