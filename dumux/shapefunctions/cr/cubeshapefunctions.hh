...
namespace Dune
{
  ...
  public:
	...
	typedef CRCubeShapeFunction ImplementationType;

    /*! \brief make a shape function object
     *
     *  \todo check the local ordering for 3D 	
     */
  ...
  public:
    ...
    typedef C CoordType; 
    typedef T ResultType;
    typedef CRCubeShapeFunctionSet<C,T,d,CRCubeShapeFunction<C,T,d> > value_type;
