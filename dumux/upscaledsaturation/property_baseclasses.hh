...
public:
    ...
    virtual Dune::Matrix<Dune::FieldMatrix<double, n, n> >& getDispersion()
    {
        Dune::Matrix<Dune::FieldMatrix<double, n, n> >& ret = *(new Dune::Matrix<Dune::FieldMatrix<double, n, n> >);
        return ret;
    }

    virtual Dune::Matrix<Dune::FieldVector<double,2*n> >& getDispersionInterface()
    {
        Dune::Matrix<Dune::FieldVector<double,2*n> >& ret = *(new Dune::Matrix<Dune::FieldVector<double, 2*n> >);
        return ret;
    }

    virtual Dune::Matrix<Dune::FieldVector<double,2*n> >& getM()
    {
        Dune::Matrix<Dune::FieldVector<double,2*n> >& ret = *(new Dune::Matrix<Dune::FieldVector<double, 2*n> >);
        return ret;
    }

    virtual Dune::Matrix<Dune::FieldVector<double, 1> >& getDispersionSat()
    {
        Dune::Matrix<Dune::FieldVector<double, 1> >& ret = *(new Dune::Matrix<Dune::FieldVector<double, 1> >);
        return ret;
    }

    virtual Dune::Matrix<Dune::FieldVector<double, 2*n> >& getDispersionSatInterface()
    {
        Dune::Matrix<Dune::FieldVector<double,2*n> >& ret = *(new Dune::Matrix<Dune::FieldVector<double, 2*n> >);
        return ret;
    }

    virtual Dune::Matrix<Dune::FieldVector<double, 2*n> >& getMSat()
    {
        Dune::Matrix<Dune::FieldVector<double,2*n> >& ret = *(new Dune::Matrix<Dune::FieldVector<double, 2*n> >);
        return ret;
    }
