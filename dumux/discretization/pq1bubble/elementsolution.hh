...
public:
    ...
    PQ1BubbleElementSolution(const Element& element, const SolutionVector& sol,
    ...
    PQ1BubbleElementSolution(const Element& element, const ElementVolumeVariables& elemVolVars,
...
-> std::enable_if_t<GridGeometry::discMethod == DiscretizationMethods::pq1bubble,
                    PQ1BubbleElementSolution<typename GridGeometry::LocalView,
                    ...
                    >
{
    ...
    return PQ1BubbleElementSolution<typename GridGeometry::LocalView, PrimaryVariables>(element, sol, gg);
}
...
-> std::enable_if_t<FVElementGeometry::GridGeometry::discMethod == DiscretizationMethods::pq1bubble,
                    PQ1BubbleElementSolution<FVElementGeometry,
                                       typename ElementVolumeVariables::VolumeVariables::PrimaryVariables>>
{
    ...
    return PQ1BubbleElementSolution<FVElementGeometry, PrimaryVariables>(element, elemVolVars, gg);
}
