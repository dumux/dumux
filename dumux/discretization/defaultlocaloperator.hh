...
template<class TypeTag, class Impl, class DiscretizationMethod>
...
template<class TypeTag, class Impl, class GridGeometry>
using DiscretizationDefaultLocalOperator
    = typename Detail::DiscretizationDefaultLocalOperator<TypeTag, Impl, typename GridGeometry::DiscretizationMethod>::type;
