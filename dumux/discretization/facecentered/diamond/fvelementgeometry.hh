...
public:
    ...
    friend inline auto cvLocalDofs(const FaceCenteredDiamondFVElementGeometry& fvGeometry)
    {
    ...
    {
        return GeometryHelper::facetCenter(this->element(), localDof.indexInElement());
    }
