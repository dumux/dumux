...
//TODO the same than other fc schemes?
...
class FaceCenteredDiamondGridVolumeVariables<Traits, /*cachingEnabled*/true>
{
    using ThisType = FaceCenteredDiamondGridVolumeVariables<Traits, true>;
...
template<class Traits>
class FaceCenteredDiamondGridVolumeVariables<Traits, /*cachingEnabled*/false>
{
    using ThisType = FaceCenteredDiamondGridVolumeVariables<Traits, false>;
