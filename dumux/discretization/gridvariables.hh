 ...
 * \brief The grid variables class for general schemes, storing variables and data
 */
 ...
 * \tparam GVC The type of the grid variables cache
 */
...
public:
    ...
    void init(const SolutionVector& curSol)
    {
        ...
        // this is outweighed by the advantage of having a single grid variables object for
