...
namespace Detail {
template<class GV, class T, bool enableHybridCVFE>
using PQ2GeometryHelper_t = Dune::Std::detected_or_t<
    Dumux::PQ2GeometryHelper<GV, typename T::SubControlVolume, typename T::SubControlVolumeFace, enableHybridCVFE>,
...
template<class Scalar,
         ...
         bool enableHybridCVFE = true,
         class Traits = PQ2DefaultGridGeometryTraits<GV>>
class PQ2FVGridGeometry
: public BaseGridGeometry<GV, Traits>
{
    using ThisType = PQ2FVGridGeometry<Scalar, GV, enableCaching, enableHybridCVFE, Traits>;
...
private:
    ...
    public:
        ...
        using GeometryHelper = Detail::PQ2GeometryHelper_t<GV, Traits, enableHybridCVFE>;
