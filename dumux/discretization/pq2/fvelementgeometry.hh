...
public:
    ...
    friend inline auto nonHybridLocalDofs(const PQ2FVElementGeometry& fvGeometry)
    {
        return std::views::iota(std::size_t(0), fvGeometry.numScv())
             ...
             | std::views::transform([fvGeometry](size_t i) { return fvGeometry.scv(i).localDofIndex(); });
    }
