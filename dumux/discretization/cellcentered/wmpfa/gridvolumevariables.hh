 ...
 */
#ifndef DUMUX_DISCRETIZATION_CC_WMPFA_GRID_VOLUMEVARIABLES_HH
#define DUMUX_DISCRETIZATION_CC_WMPFA_GRID_VOLUMEVARIABLES_HH

#include <dumux/discretization/cellcentered/wmpfa/elementvolumevariables.hh>
#include <dumux/discretization/cellcentered/gridvolumevariables.hh>

namespace Dumux {

template<class P, class VV>
struct CCWMpfaDefaultGridVolumeVariablesTraits
{
    using Problem = P;
    using VolumeVariables = VV;

    template<class GridVolumeVariables, bool cachingEnabled>
    using LocalView = CCWMpfaElementVolumeVariables<GridVolumeVariables, cachingEnabled>;
};
...
template<class Problem,
         ...
         class Traits = CCWMpfaDefaultGridVolumeVariablesTraits<Problem, VolumeVariables> >
class CCWMpfaGridVolumeVariables : public CCGridVolumeVariables<Traits, cachingEnabled>
{
public:
