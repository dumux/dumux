 ...
 * \brief The grid volume variables class for cell centered Godunov models
 */
#ifndef DUMUX_DISCRETIZATION_CC_GODUNOV_GRID_VOLUMEVARIABLES_HH
#define DUMUX_DISCRETIZATION_CC_GODUNOV_GRID_VOLUMEVARIABLES_HH

#include <dumux/discretization/cellcentered/godunov/elementvolumevariables.hh>
#include <dumux/discretization/cellcentered/gridvolumevariables.hh>

namespace Dumux {

template<class P, class VV>
struct GodunovDefaultGridVolumeVariablesTraits
{
    using Problem = P;
    using VolumeVariables = VV;

    template<class GridVolumeVariables, bool cachingEnabled>
    using LocalView = GodunovElementVolumeVariables<GridVolumeVariables, cachingEnabled>;
};
...
template<class Problem,
         ...
         class Traits = GodunovDefaultGridVolumeVariablesTraits<Problem, VolumeVariables> >
class GodunovGridVolumeVariables : public CCGridVolumeVariables<Traits, cachingEnabled>
{
public:
