 ...
 */
#ifndef DUMUX_DISCRETIZATION_GODUNOV_ELEMENT_FLUXVARSCACHE_HH
#define DUMUX_DISCRETIZATION_GODUNOV_ELEMENT_FLUXVARSCACHE_HH
...
class GodunovElementFluxVariablesCache;
 ...
 */
template<class GFVC>
class GodunovElementFluxVariablesCache<GFVC, true>
{
public:
    ...
    GodunovElementFluxVariablesCache(const GridFluxVariablesCache& global)
 ...
 */
template<class GFVC>
class GodunovElementFluxVariablesCache<GFVC, false>
{
public:
    //! export the type of the grid flux variables cache
    using GridFluxVariablesCache = GFVC;
    ...
    /*!
     * \brief Update if the volume variables have changed
