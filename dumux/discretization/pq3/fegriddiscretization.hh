...
public:
    ...
    //! Constructor
    PQ3FEGridDiscretization(std::shared_ptr<BasicGridGeometry> gd)
    ...
    friend inline LocalView localView(const PQ3FEGridDiscretization& gd)
    { return { gd.cache_ }; }
...
private:
    ...
    public:
        ...
        explicit PQ3FEGridDiscretizationCache(const PQ3FEGridDiscretization& gd)
