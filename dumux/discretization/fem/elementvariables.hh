...
public:
    ...
    template<class IpData>
    requires (Concept::IntersectionQpIpData<IpData> || Concept::QIpData<IpData>)
    friend const InterpolationPointData& cache(const FEElementVariables& elemVars,
                                               const IpData& ipData)
    {
        if constexpr (Concept::IntersectionQpIpData<IpData>)
    ...
    */
    ...
    FEElementVariables bind(const typename FVElementGeometry::GridGeometry::GridView::template Codim<0>::Entity& element,
    ...
    */
    template<class FVElementGeometry, class SolutionVector>
    FEElementVariables bindElement(const typename FVElementGeometry::GridGeometry::GridView::template Codim<0>::Entity& element,
                                     const FVElementGeometry& fvGeometry,
                                     const SolutionVector& sol)  &&
    {
        this->bindElement(element, fvGeometry, sol);
