 ...
 * \brief The local element solution class for finite element schemes.
 */
...
public:
    ...
    void update(const Element& element,
                ...
                const GridGeometry& gridGeometry)
    {
        const auto& feBasis = gridGeometry.feBasis();
    ...
    //! Access to the underlying primary variables
    const PrimaryVariables& operator [](unsigned int i) const
    { return priVars_[i]; }

    //! Access to the underlying primary variables
    PrimaryVariables& operator [](unsigned int i)
    { return priVars_[i]; }
