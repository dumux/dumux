 ...
 * \brief Base class for the local finite volume geometry for cvfe models
 *        This builds up the sub control volumes and sub control volume faces
 *        for an element.
 */
#ifndef DUMUX_DISCRETIZATION_CVFE_FV_ELEMENT_GEOMETRY_HH
#define DUMUX_DISCRETIZATION_CVFE_FV_ELEMENT_GEOMETRY_HH
...
class CvfeFVElementGeometry;

//! specialization in case the FVElementGeometries are stored
template<class GG>
class CvfeFVElementGeometry<GG, true>
{
...
public:
    ...
    //! Constructor
    CvfeFVElementGeometry(const GridGeometry& gridGeometry)
    ...
    scvs(const CvfeFVElementGeometry& fvGeometry)
    {
    ...
    scvfs(const CvfeFVElementGeometry& fvGeometry)
    {
        const auto& g = fvGeometry.gridGeometry();
     ...
     */
    CvfeFVElementGeometry bind(const Element& element) &&
    {
    ...
    //! The cvfe stencil is always element-local so bind and bindElement
    //! are identical.
     ...
     */
    CvfeFVElementGeometry bindElement(const Element& element) &&
    {
        this->bindElement(element);
        return std::move(*this);
    }
