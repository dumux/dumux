...
public:
    ...
    //! export type of variables context
    template<class FVElementGeometry>
    using VariablesContext = LocalDofVariablesContext<MutableView, FVElementGeometry>;
...
public:
    ...
    //! export type to variables context
    template<class FVElementGeometry>
    using VariablesContext = LocalDofVariablesContext<MutableView, FVElementGeometry>;
