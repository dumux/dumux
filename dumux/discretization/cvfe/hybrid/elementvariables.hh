 ...
 * \brief The element variables class for hybrid control-volume finite element methods
 */
...
/*!
 * \ingroup CVFEDiscretization
 * \brief The (stencil) element variables class for hybrid control-volume finite element
...
/*!
 * \ingroup CVFEDiscretization
 * \brief The (stencil) element variables class for hybrid control-volume finite element with caching
...
public:
    ...
    */
    ...
    HybridCVFEElementVariables bind(const typename FVElementGeometry::Element& element,
    ...
    */
    template<class FVElementGeometry, class SolutionVector>
    HybridCVFEElementVariables bindElement(const typename FVElementGeometry::Element& element,
                                           const FVElementGeometry& fvGeometry,
                                           const SolutionVector& sol) &&
    {
        this->bindElement(element, fvGeometry, sol);
