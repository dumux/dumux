 ...
 * \brief Base class for the finite volume geometry vector for cvfe models
 *        This builds up the sub control volumes and sub control volume faces
 *        for each element of the grid partition.
 */
#ifndef DUMUX_DISCRETIZATION_CVFE_GRID_FVGEOMETRY_HH
#define DUMUX_DISCRETIZATION_CVFE_GRID_FVGEOMETRY_HH
...
#include <dumux/discretization/cvfe/geometryhelper.hh>
#include <dumux/discretization/cvfe/fvelementgeometry.hh>
#include <dumux/discretization/cvfe/subcontrolvolume.hh>
...
struct CvfeMapperTraits :public DefaultMapperTraits<GridView>
{
...
/*!
 * \ingroup CvfeDiscretization
 * \brief The default traits for the cvfe finite volume grid geometry
 *        Defines the scv and scvf types and the mapper types
 * \tparam the grid view type
 */
template<class GridView, class MapperTraits = CvfeMapperTraits<GridView>>
struct CvfeDefaultGridGeometryTraits
: public MapperTraits
{
    using SubControlVolume = CvfeSubControlVolume<GridView>;
    using SubControlVolumeFace = CvfeSubControlVolumeFace<GridView>;

    template<class GridGeometry, bool enableCache>
    using LocalView = CvfeFVElementGeometry<GridGeometry, enableCache>;
};
