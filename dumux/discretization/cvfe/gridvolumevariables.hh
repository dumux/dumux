 ...
 * \brief The grid volume variables class for cvfe models
 */
...
class CvfeGridVolumeVariables<P, VV, /*cachingEnabled*/true, Traits>
{
    using ThisType = CvfeGridVolumeVariables<P, VV, true, Traits>;
...
template<class P, class VV, class Traits>
class CvfeGridVolumeVariables<P, VV, /*cachingEnabled*/false, Traits>
{
    using ThisType = CvfeGridVolumeVariables<P, VV, false, Traits>;
