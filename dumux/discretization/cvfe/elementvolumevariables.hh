...
/*!
 * \ingroup CvfeDiscretization
 * \brief The local (stencil) volume variables class for cvfe models
...
/*!
 * \ingroup CvfeDiscretization
 * \brief The local (stencil) volume variables class for cvfe models with caching
...
/*!
 * \ingroup CvfeDiscretization
 * \brief The local (stencil) volume variables class for cvfe models without caching
 */
template<class GVV>
...
public:
    ...
    */
    ...
    // specialization for cvfe models, simply forwards to the bindElement method
    template<class FVElementGeometry, class SolutionVector>
    void bind(const typename FVElementGeometry::GridGeometry::GridView::template Codim<0>::Entity& element,
              const FVElementGeometry& fvGeometry,
              const SolutionVector& sol) &
    ...
    */
    ...
    // specialization for cvfe models
    template<class FVElementGeometry, class SolutionVector>
    void bindElement(const typename FVElementGeometry::GridGeometry::GridView::template Codim<0>::Entity& element,
                     const FVElementGeometry& fvGeometry,
                     const SolutionVector& sol) &
