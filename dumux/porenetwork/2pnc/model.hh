...
public:
    using type = Dumux::PoreNetwork::TwoPNCVolumeVariables<NCTraits<BaseTraits, DT, EDM>>;
};
...
template<class TypeTag>
struct IOFields<TypeTag, TTag::PNMTwoPNCNI> { using type = EnergyIOFields<Dumux::PoreNetwork::TwoPNCIOFields>; };
