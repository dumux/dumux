...
template<class Problem,
         ...
         bool cachingEnabled,
         class Traits>
class PNMTwoPNCGridFluxVariablesCache;
...
class PNMTwoPNCGridFluxVariablesCache<P, FVC, true, Traits>
{
    using Problem = typename Traits::Problem;
    using ThisType = PNMTwoPNCGridFluxVariablesCache<P, FVC, true, Traits>;
    ...
    PNMTwoPNCGridFluxVariablesCache(const Problem& problem)
    : problemPtr_(&problem)
 ...
 */
template<class P, class FVC, class Traits>
class PNMTwoPNCGridFluxVariablesCache<P, FVC, false, Traits>
{
    using Problem = typename Traits::Problem;
    using ThisType = PNMTwoPNCGridFluxVariablesCache<P, FVC, false, Traits>;
    using InvasionState = PNMTwoPInvasionState<Problem>;
