...
auto makeGridformatReaderFactory() {
    return [fac = GridFormat::AnyReaderFactory<>{}] (const std::string& f)
...
public:
    ...
    : reader_(GridFormat::Reader::from(fileName, Detail::VTKReader::makeGridformatReaderFactory()))
    {}
