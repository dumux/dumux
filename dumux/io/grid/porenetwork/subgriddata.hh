...
public:
    PoreNetworkSubGridData(const SubGrid& subGrid,
                           std::shared_ptr<const PoreNetworkGridData<HostGrid>> hostGridData)
    : subGrid_(subGrid)
...
private:
    ...
    std::shared_ptr<const PoreNetworkGridData<HostGrid>> hostGridData_;
};
