...
/**
 * \ingroup stokes
 * \defgroup stokesProblems Problems
 */

namespace Dune
{
  /*! \ingroup stokesProblems 
   * @brief base class that defines the parameters of a stokes equation 
   * 
   * An interface for defining parameters for the stationary stokes equation 
  ...
  public:
	 ...
	 */
	StokesProblem(VC& variableobject, TwoPhaseRelations& law = *(new LinearLaw), 
