...
{
    using ThisType = SolidPhase<Scalar, ComponentT>;
public:
     ...
     */
    static constexpr bool isInert(int compIdx = 0)
    { return true; }
    ...
    { return Component::solidDensity(temperature, pressure); }
    ...
    static Scalar density(const SolidState& solidState,
                          const int phaseIdx)
    {
        return density(solidState.temperature(phaseIdx),
                       solidState.pressure(phaseIdx));
    }

    /*!
     * \brief Specific internal energy \f$\mathrm{[J/kg]}\f$ the solid phase
     */
    static const Scalar internalEnergy(Scalar temperature, Scalar pressure)
    { return Component::solidInternalEnergy(temperature, pressure); }

    /*!
     * \brief Thermal conductivity of the solid \f$\mathrm{[W/(m K)]}\f$.
     */
    static Scalar thermalConductivity(Scalar temperature, Scalar pressure)
    { return Component::solidThermalConductivity(temperature, pressure); }
    ...
    static Scalar thermalConductivity(const SolidState &solidState,
                                    const int phaseIdx)
    {
        return thermalConductivity(solidState.temperature(phaseIdx),
                                   solidState.pressure(phaseIdx));
    }
    ...
    { return Component::solidHeatCapacity(temperature, pressure); }
    ...
    static Scalar heatCapacity(const SolidState &solidState,
                               const int phaseIdx)
    {
        return heatCapacity(solidState.temperature(phaseIdx),
                            solidState.pressure(phaseIdx));
    }
};
