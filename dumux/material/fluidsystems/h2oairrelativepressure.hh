 ...
 */
#ifndef DUMUX_H2O_AIR_RELPRESS_SYSTEM_HH
#define DUMUX_H2O_AIR_RELPRESS_SYSTEM_HH
...
{
    typedef H2OAirRelPress<Scalar,H2Otype, useComplexRelations > ThisType;
...
public:
    typedef H2Otype H2O;
    typedef Dumux::AirRelPress<Scalar> Air;
                                      ...
                                      const int compIdx)
    {
        ...
        return fugacityCoefficient(fluidState, phaseIdx, compIdx)
               * (fluidState.pressure(phaseIdx)+1e5)
