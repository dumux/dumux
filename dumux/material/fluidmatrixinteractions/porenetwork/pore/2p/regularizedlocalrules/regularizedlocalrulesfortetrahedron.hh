 ...
 */
#ifndef REGULARIZED_PNM_2P_LOCAL_RULES_FOR_TETRAHEDRON_HH
#define REGULARIZED_PNM_2P_LOCAL_RULES_FOR_TETRAHEDRON_HH
...
class RegularizedTwoPLocalRulesTetrahedron : public RegularizedTwoPLocalRulesBase
{
    using LocalRules = TwoPLocalRulesTetrahedron<ScalarT>;
