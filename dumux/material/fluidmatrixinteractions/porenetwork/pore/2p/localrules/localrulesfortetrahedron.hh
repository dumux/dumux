 ...
 */
#ifndef DUMUX_PNM_2P_LOCAL_RULES_FOR_TETRAHEDRON_HH
#define DUMUX_PNM_2P_LOCAL_RULES_FOR_TETRAHEDRON_HH
...
struct TwoPLocalRulesTetrahedron : public TwoPLocalRulesBase
{
    ...
    static Scalar pc(const Params& params, const Scalar sw)
    {
        ...
        return 2*sigma / (poreRadius*(1 - std::exp(-3.87*sw))) ;
    }
    ...
    static Scalar sw(const Params& params, const Scalar pc)
    {
        ...
        const Scalar sigma = params.surfaceTension;
        using std::log;
        return  - 1/3.87* log(1 - 1/poreRadius * 2*sigma / pc);
    }
