 ...
 */
#ifndef DUMUX_MATERIAL_FLUIDMATRIX_TWOPIA_INTERFACIAL_AREA_HH
#define DUMUX_MATERIAL_FLUIDMATRIX_TWOPIA_INTERFACIAL_AREA_HH
...
template<class ScalarType,
         class BaseLaw,
         class Regularization = NoAwnRegularization<ScalarType>,
...
public:
    ...
    { return !std::is_same<Regularization, NoAwnRegularization<ScalarType>>::value; }
