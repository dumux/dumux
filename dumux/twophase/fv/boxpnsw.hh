...
#include "dumux/twophase/twophasemodel_pnsw.hh"
...
class BoxPnSw
: public LeafP1TwoPhaseModel<G, RT, TwoPhaseProblem<G, RT>, BoxPnSwJacobian<G, RT> >
{
...
public:
	...
	typedef BoxPnSw<G, RT, VtkMultiWriter> ThisType;
	...
	virtual void initial()
	{
		...
		this->localJacobian().outPressureW = vtkMultiWriter->template createField<RT, 1>(this->size);
...
//        std::cout << Flux << ", "<< Mass;
	...
	{
//		// overwrite for pnsw-formulation
//		for (int i = 0; i < size; i++) {
//			this->localJacobian.outPressureN[i] = (*(this->u))[i][0];
//			this->localJacobian.outSaturationW[i] = (*(this->u))[i][1];
//			this->localJacobian.outSaturationN[i] = 1 - this->localJacobian.outSaturationW[i];
//			}
