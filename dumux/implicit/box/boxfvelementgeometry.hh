...
public:
    ...
    GlobalPosition edgeCoord[maxNE]; //!< \deprecated global coordinates of the edge centers
    GlobalPosition faceCoord[maxNF]; //!< \deprecated global coordinates of the face centers
