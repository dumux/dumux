...
NEW_PROP_TAG(PrimaryInteractionVolume); //! The inner interaction volume type
NEW_PROP_TAG(SecondaryInteractionVolume); //! The interaction volume type used on the boundaries
