...
class VtkOutputModuleImpl : public Dumux::VtkOutputModule<GridVariables, SolutionVector>
{
...
public:
    ...
    //! The constructor
    VtkOutputModuleImpl(const GridVariables& gridVariables,
...
{
    template<class ...T>
    using type = VtkOutputModuleImpl<false, T...>;
};
...
{
    template<class T>
    using type = VtkOutputModuleImpl<true, typename Detail::TypeTagHelper<T>::GridVariables, typename Detail::TypeTagHelper<T>::FluxVariables, typename Detail::TypeTagHelper<T>::SolutionVector>;
};

}

template<class ...T>
using VtkOutputModule = typename Detail::ImplHelper<sizeof...(T)>::template type<T...>;
