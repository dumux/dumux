...
template<class TypeTag, class MyTypeTag>
struct ZeroPc { using type = UndefinedProperty; };
...
template<class TypeTag>
struct HeatConductionType<TypeTag, TTag::PoreNetworkModel> { using type = Dumux::PNMFouriersLaw; };

//! The labels
template<class TypeTag>
struct Labels<TypeTag, TTag::PoreNetworkModel> { using type = Dumux::Labels; };
...
public:
    using type = Dumux::PNMVelocityOutput<GridVariables, FluxVariables>;
};
