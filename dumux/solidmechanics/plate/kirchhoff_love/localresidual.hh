 ...
 * \brief Local residual for the Kirchhoff-Love model
 */
#ifndef DUMUX_KIRCHHOFF_LOVE_PLATE_LOCAL_RESIDUAL_HH
#define DUMUX_KIRCHHOFF_LOVE_PLATE_LOCAL_RESIDUAL_HH
...
/*!
 * \ingroup KirchhoffLovePlate
 * \brief Local residual for the Kirchhoff-Love model (deformation and potentials)
 */
template<class TypeTag>
class KirchhoffLovePlateLocalResidualDeformation
...
/*!
 * \ingroup KirchhoffLovePlate
 * \brief Local residual for the Kirchhoff-Love model (rotations)
 */
template<class TypeTag>
class KirchhoffLovePlateLocalResidualRotation
: public DiscretizationDefaultLocalOperator<TypeTag>
{
    using ParentType = DiscretizationDefaultLocalOperator<TypeTag>;
    using Scalar = GetPropType<TypeTag, Properties::Scalar>;
