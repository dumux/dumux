...
if (EXISTS ${CMAKE_SOURCE_DIR}/deps/gridformat/CMakeLists.txt)
    if (${CXX_MAX_STANDARD} LESS 20)
        message(STATUS "Gridformat library is not included as it requires C++20")
    else ()
...
set(DUMUX_HAVE_XPRESS false)
if (EXISTS ${CMAKE_SOURCE_DIR}/deps/xpress/CMakeLists.txt)
    if (${CXX_MAX_STANDARD} LESS 23)
        message(STATUS "xpress library is not included as it requires C++23")
    else ()

        message(STATUS "Including xpress in the source tree")
        set(XPRESS_BUILD_TESTS OFF)
        set(XPRESS_BUILD_EXAMPLES OFF)
        set(XPRESS_BUILD_BENCHMARK OFF)
        add_subdirectory(${CMAKE_SOURCE_DIR}/deps/xpress)
        set(DUMUX_HAVE_XPRESS true)
    endif ()
endif ()
