...
set(DUMUX_HAVE_ADPP false)
if (EXISTS ${CMAKE_SOURCE_DIR}/deps/adpp/CMakeLists.txt)
    if (${CXX_MAX_STANDARD} LESS 23)
        message(STATUS "adpp library is not included as it requires C++23")
    else ()

        message(STATUS "Including adpp in the source tree")
        add_subdirectory(${CMAKE_SOURCE_DIR}/deps/adpp)
    endif ()
endif ()
