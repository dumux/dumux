...
$ wget https://git.iws.uni-stuttgart.de/dumux-repositories/dumux-course/raw/releases/3.3/scripts/install.sh
\end{lstlisting}
...
The above script will download the correct version (\textbf{releases/3.3}) of both
