...
This is the handbook to a new minor version update of \Dumux: version 3.3.
...
helping to update programs from version 3.2 to version 3.3, and giving an overview over new capabilities.
