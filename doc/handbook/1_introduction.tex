...
The release contains improvements and new features compared to the version \DumuxOldVersion.
...
helping to update programs from version \DumuxOldVersion{} to version \DumuxVersion, and giving an overview over new capabilities.
