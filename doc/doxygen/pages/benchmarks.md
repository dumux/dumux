...
| [![rotating cylinders](https://git.iws.uni-stuttgart.de/benchmarks/rotating-cylinders/-/raw/main/images/analytical_comparison.png)](https://git.iws.uni-stuttgart.de/benchmarks/rotating-cylinders) | [↗️ Taylor-Couette](https://git.iws.uni-stuttgart.de/benchmarks/rotating-cylinders) | 2D, free flow, Taylor-Couette flow, @ref NavierStokesModel | A DuMux module for the Taylor-Couette benchmark of viscous flow between two concentric, independently rotating cylinders; velocity and pressure fields verified against the analytical solution of [Taylor (1923)](https://doi.org/10.1098/rsta.1923.0008). |
