...
| | @ref benchmark-boussinesq-convection "↗️ Boussinesq Convection" | @ref OnePNCModel, @ref BoxDiscretization, parallel h-adaptivity, dynamic load balancing | Rayleigh-Bénard-type dissolutive convection (Riaz et al. 2006); primarily a stress test for MPI + h-adaptive refinement + dynamic rebalancing running together |
