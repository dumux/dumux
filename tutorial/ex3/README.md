...
* The __main file__ for part a: `ex3_a.cc`
* The __input file__ for part a: `ex3_a.input`
* The __problem file__ for part a: `ex3_a_problem.hh`
* The __main file__ for part b: `ex3_b.cc`
* The __input file__ for part b: `ex3_b.input`
* The __problem file__ for part b: `ex3_b_problem.hh`
...
In the following the basic steps required to set the desired fluid system are outlined. Here, this is done in the __problem file__, i.e. for this part of the exercise the code shown below is taken from the `ex3_a_problem.hh` file.
