...
SET_SCALAR_PROP(Ex2TutorialProblemDecoupled, CFLFactor, 0.95); /*@\label{tutorial-decoupled:cflfactor}@*/

// Disable gravity
SET_BOOL_PROP(Ex2TutorialProblemDecoupled, EnableGravity, false); /*@\label{tutorial-decoupled:gravity}@*/
