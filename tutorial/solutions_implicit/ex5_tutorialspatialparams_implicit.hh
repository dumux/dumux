 ...
 */
#ifndef DUMUX_TUTORIAL_EX5_SPATIAL_PARAMS_IMPLICIT_HH
#define DUMUX_TUTORIAL_EX5_SPATIAL_PARAMS_IMPLICIT_HH
...
class Ex5TutorialSpatialParamsImplicit;

namespace Properties
{
// The spatial parameters TypeTag
NEW_TYPE_TAG(Ex5TutorialSpatialParamsImplicit);/*@\label{tutorial-implicit:define-spatialparameters-typetag}@*/

// Set the spatial parameters
SET_TYPE_PROP(Ex5TutorialSpatialParamsImplicit, SpatialParams,
        Dumux::Ex5TutorialSpatialParamsImplicit<TypeTag>); /*@\label{tutorial-implicit:set-spatialparameters}@*/

// Set the material law
SET_PROP(Ex5TutorialSpatialParamsImplicit, MaterialLaw)
{
private:
 ...
 */
template<class TypeTag>
class Ex5TutorialSpatialParamsImplicit: public ImplicitSpatialParams<TypeTag> /*@\label{tutorial-implicit:tutorialSpatialParameters}@*/
{
...
public:
    ...
    // constructor
    Ex5TutorialSpatialParamsImplicit(const GridView& gridView) :
