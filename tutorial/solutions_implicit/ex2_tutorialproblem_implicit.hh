 ...
 */
#ifndef DUMUX_EX2_TUTORIAL_PROBLEM_IMPLICIT_HH    // guardian macro /*@\label{tutorial-implicit:guardian1}@*/
#define DUMUX_EX2_TUTORIAL_PROBLEM_IMPLICIT_HH    // guardian macro /*@\label{tutorial-implicit:guardian2}@*/
...
class Ex2TutorialProblemImplicit;

namespace Properties {
// Create a new type tag for the problem
NEW_TYPE_TAG(Ex2TutorialProblemImplicit, INHERITS_FROM(BoxTwoP, Ex2TutorialSpatialParamsImplicit)); /*@\label{tutorial-implicit:create-type-tag}@*/

// Set the "Problem" property
SET_PROP(Ex2TutorialProblemImplicit, Problem) /*@\label{tutorial-implicit:set-problem}@*/
{ typedef Dumux::Ex2TutorialProblemImplicit<TypeTag> type;};

// Set grid and the grid creator to be used
#if HAVE_DUNE_ALUGRID /*@\label{tutorial-implicit:set-grid}@*/
SET_TYPE_PROP(Ex2TutorialProblemImplicit, Grid, Dune::ALUGrid</*dim=*/2, 2, Dune::cube, Dune::nonconforming>); /*@\label{tutorial-implicit:set-grid-ALU}@*/
#elif HAVE_UG
SET_TYPE_PROP(Ex2TutorialProblemImplicit, Grid, Dune::UGGrid<2>);
#else
...
SET_PROP(Ex2TutorialProblemImplicit, NonwettingPhase)
{
private: typedef typename GET_PROP_TYPE(TypeTag, Scalar) Scalar;
...
SET_TYPE_PROP(Ex2TutorialProblemImplicit, FluidSystem, Dumux::TwoPImmiscibleFluidSystem<TypeTag>);
// Disable gravity
SET_BOOL_PROP(Ex2TutorialProblemImplicit, ProblemEnableGravity, false); /*@\label{tutorial-implicit:gravity}@*/
}
 ...
 */
template <class TypeTag>
class Ex2TutorialProblemImplicit : public ImplicitPorousMediaProblem<TypeTag> /*@\label{tutorial-implicit:def-problem}@*/
{
...
public:
    Ex2TutorialProblemImplicit(TimeManager &timeManager,
