...
NEW_TYPE_TAG(TutorialProblemCoupled, INHERITS_FROM(CCTwoP, TutorialSpatialParamsCoupled)); /*@\label{tutorial-coupled:create-type-tag}@*/
...
SET_PROP(TutorialProblemCoupled, NonwettingPhase) /*@\label{tutorial-coupled:2p-system-start}@*/
{
 ...
 */
template <class TypeTag>
class TutorialProblemCoupled : public ImplicitPorousMediaProblem<TypeTag> /*@\label{tutorial-coupled:def-problem}@*/
{
...
public:
    ...
    void dirichletAtPos(PrimaryVariables &values, const GlobalPosition &globalPos) const
    {
        ...
        values[Indices::snIdx] = 0.5; // 0 % oil saturation on left boundary
    }
