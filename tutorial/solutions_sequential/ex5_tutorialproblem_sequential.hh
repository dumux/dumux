...
{
    typedef Ex5TutorialProblemSequential<TypeTag> type;
};
...
SET_TYPE_PROP(Ex5TutorialProblemSequential, EvalCflFluxFunction, EvalCflFluxCoats<TypeTag>); /*@\label{tutorial-sequential:cflflux}@*/
