...
- __LocalResidual__: Several implementation have relied on the property `Properties::BaseLocalResidual`.
The property has been removed. Instead we use a new class called `DiscretiaztionDefaultLocalOperator`.
This backwards-incompatible change should only affect implementers of discretization methods.
