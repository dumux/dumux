...
int main(int argc, char** argv) try
{
    ...
    if (hasParam("Injection.NumInjections"))
    {
        ...
        for (int epiIdx = 0; epiIdx < injectionCheckPoints.size(); ++epiIdx)
            timeLoop->setCheckPoint(injectionCheckPoints[epiIdx]);
    ...
    timeLoop->start(); do
    {
        ...
        // and solve the linear system with time step control
        ...
        // We write vtk output and report statistics of this time step
