...
public:
    ...
    : ParentType(gridGeometry)
    {
        ...
        injectionType_ = readFileToContainer<std::vector<int>>("injections_type.dat");
       // [[/codeblock]]
    ...
    NumEqVector neumannAtPos(const GlobalPosition& globalPos) const
    {
        ...
        const int injProcess = injectionType_[episodeIdx_];
        if (injProcess == -99 || injProcess == 9)
            return NumEqVector(0.0);
