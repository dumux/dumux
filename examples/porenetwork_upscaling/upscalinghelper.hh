...
public:
    ...
    void setSamplePoints(const Problem& problem, const Scalar totalMassFlux)
    {
        ...
        // set sample point for intrinsic permability calculation
        const auto samplePointY = problem.pressureGradient() / problem.liquidDynamicViscosity() / vDarcy;
        const auto samplePointX = problem.liquidDensity() * vDarcy / problem.liquidDynamicViscosity();
        ...
        const auto forchheimerNumber = problem.liquidDensity() * vDarcy / problem.liquidDynamicViscosity();
