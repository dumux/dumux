 ...
 * \file
 *
 * \brief Properties file for upscaling using the pore network model
 */
 #include <config.h>
...
#include "transmissibilityhelper.hh"
#include "problem_static.hh"
#include "problem_singlephase.hh"
...
template<class TypeTag>
struct Problem<TypeTag, TTag::PNMTWOPStatic> { using type = Dumux::PoreNetwork::PNMProblemStatic<TypeTag>; };
