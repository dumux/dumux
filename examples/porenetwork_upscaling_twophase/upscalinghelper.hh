...
{
public:
    // ### Set data points to calculate intrinsic permeability
    ...
    static void plot()
    {
        // // plot effective permeability and capillary pressure vs. wetting phase saturation
        plotEffPermeabilityVsSw_();
...
private:
    ...
    static void plotEffPermeabilityVsSw_()
    {
