...
#include "2d_bump_transcritical_problem.hh"
...
int main(int argc, char** argv)
{
  try{
    ...
    Dune::FieldVector<int,dim> N(100);  N[0] = 50; N[1] = 4;
    FieldVector L(0);
    FieldVector H(0); H[0] = 25; H[1] = 4;
    GridType grid(N,L,H);
...
//    dgfFileName << "grids/unitcube" << GridType :: dimension << ".dgf";
    ...
    Dune::TimeLoop<GridType, ShallowWater> timeloop(tStart, tEnd, "2dbump_transcritical", modulo, cFLFactor, maxDt, firstDt, explicitEuler);
