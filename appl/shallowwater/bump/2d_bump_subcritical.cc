...
int main(int argc, char** argv)
{
  ...
  Copy of 2d_bump_subcritical.cc  typedef Dune::FieldVector<GridType::ctype,dim> FieldVector;
    Dune::FieldVector<int,dim> N(100);  N[0] = 25; N[1] = 1;
    FieldVector L(0);
    FieldVector H(0); H[0] = 25; H[1] = 1;
    GridType grid(N,L,H);
