...
#include "2d_pulse_problem_noflow.hh"
...
//    dgfFileName << "grids/unitcube" << GridType :: dimension << ".dgf";
    ...
    Dune::TimeLoop<GridType, ShallowWater> timeloop(tStart, tEnd, "2d_pulse_noflow", modulo, cFLFactor, maxDt, firstDt, explicitEuler);
