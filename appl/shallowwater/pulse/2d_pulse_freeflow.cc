...
#include "2d_pulse_freeflow_problem.hh"
...
//    dgfFileName << "grids/unitcube" << GridType :: dimension << ".dgf";
    ...
    Dune::TimeLoop<GridType, ShallowWater> timeloop(tStart, tEnd, "2d_pulse_freeflow", modulo, cFLFactor, maxDt, firstDt, explicitEuler);
