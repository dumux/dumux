...
int main(int argc, char** argv)
{
    try {
        ...
        Dune::Fivespotcase2TransportProblem<GridType, NumberType, VC> transportProblem(variables, materialLaw, bcf);
        Dune::Fivespotcase2DiffProblem<GridType, NumberType, VC> diffusionProblem(variables, materialLaw, bcf);
