...
// forward declartion of the 2p2cni box model
template<class ProblemT, class TwoPTwoCNITraitsT>
...
class TwoPTwoCNIBoxJacobian : public TwoPTwoCBoxJacobianBase<ProblemT,
                                                             ...
                                                             >
{
    friend class TwoPTwoCNIBoxModel<ProblemT, TwoPTwoCNITraitsT>;
                     ...
                     const ElementData &elementCache) const
    {
        ...
        result[temperatureIdx] =
            ...
            this->problem_.soil().heatCap(this->curElementGeom_.elementGlobal,
                                          this->curElement_(),
                                          this->curElementGeom_.elementLocal, scvId)*
...
public:
                              ...
                              Scalar temperature) const
    {
        ...
        vertDat.lambda = problem.soil().heatCond(global, element, local, vertDat.satW, localIdx);
...
public:
    ...
    /*!
     * \brief Calculate the masses of the wetting and the nonwetting phase 
     * component for the current timestep.
     */
