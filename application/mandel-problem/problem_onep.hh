 ...
 */
template <class TypeTag>
class MandelOnePSubproblem : public PorousMediumFlowProblem<TypeTag>
{
...
public:
    MandelMandelOnePSubproblem(std::shared_ptr<const GridGeometry> gridGeometry,
